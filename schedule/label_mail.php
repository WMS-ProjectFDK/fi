...
$message .='
	  <div>
	  	...
	  	<table>
	  		<tr>
		       <th style="background-color: #D2D2D2;width: 100px; height: 25px;" align="center">LINE</th>
		       <th style="background-color: #D2D2D2;width: 150px; height: 25px;" align="center">PLAN</th>
		       <th style="background-color: #D2D2D2;width: 150px; height: 25px;" align="center">ACTUAL</th>
		       <th style="background-color: #D2D2D2;width: 150px; height: 25px;" align="center">GAP</th>
		    </tr>';
...
for ($h=0; $h < count($items0) ; $h++) { 
	...
	if ($ln_lr30 == 'LR03') {
		...
		$message.= '<tr>
						<td  style="background-color: #DDEBF7;width: 100px;" >'.$ln_lr30.'</td>
		...
		$message.= '<tr>
						<td  style="background-color: #DDEBF7;width: 100px;" >'.$ln_lr60.'</td>
			...
			$message.= '<tr>
						<td  style="background-color: #DDEBF7;width: 100px;" >TOTAL</td>
...
$message .='
				<p>2. a. Summary label Yesterday at '.$on_date.' : <br/></p>
	  	<table>
	  		<tr>
		       <th style="background-color: #D2D2D2;width: 100px; height: 25px;" align="center">LINE</th>
		       <th style="background-color: #D2D2D2;width: 150px; height: 25px;" align="center">PLAN</th>
...
$message .='
  	  ...
  	  <p> 2. b. Label report details on '.$on_date.' : <br/></p>
	  <table>
	  	<tr>
	       <th style="background-color: #D2D2D2;width: 250px; height: 25px;" align="center">Line - Remark </th>
	       <th style="background-color: #D2D2D2;width: 100px; height: 25px;" align="center">Accumulation / Line </th>
	       <th style="background-color: #D2D2D2;width: 100px; height: 25px;" align="center">Daily / Line </th>
	       <th style="background-color: #D2D2D2;width: 100px; height: 25px;" align="center">SHIFT-1</th>
	       <th style="background-color: #D2D2D2;width: 100px; height: 25px;" align="center">SHIFT-2</th>
	       <th style="background-color: #D2D2D2;width: 100px; height: 25px;" align="center">SHIFT-3</th>
	    </tr>';
...
for ($i=0; $i < count($items) ; $i++) { 
	...
	if ($ln_lr3 == 'LR03') {
		$message.= '<tr>
						<td style="background-color: #FCE4D6;width: 250px;" >ACTUAL '.str_replace('"', '', json_encode($items[$i]->LABELLINE)).'</td>
						<td style="background-color: #FCE4D6;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($items[$i]->ACCUMULATION))).'</td>
						<td style="background-color: #FCE4D6;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($items[$i]->DAILY))).'</td>
						<td style="background-color: #FCE4D6;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($items[$i]->SHIFT1))).'</td>
						<td style="background-color: #FCE4D6;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($items[$i]->SHIFT2))).'</td>
						<td style="background-color: #FCE4D6;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($items[$i]->SHIFT3))).'</td>
					</tr>';
	}elseif($ln_lr6 == 'LR6'){
		if($i == 2){
			$message.= '<tr>
							<td style="background-color: #DDEBF7;width: 100px;" >SUB TOTAL ACTUAL LR#03 </td>
							
							<td style="background-color: #DDEBF7;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($Accum3))).'</td>
							<td style="background-color: #DDEBF7;width: 70px;" align="right">'.number_format(str_replace('"', '', json_encode($daily3))).'</td>

							<td style="background-color: #DDEBF7;width: 70px;" align="right">'.number_format(str_replace('"', '', json_encode($tot3_1))).'</td>
							<td style="background-color: #DDEBF7;width: 70px;" align="right">'.number_format(str_replace('"', '', json_encode($tot3_2))).'</td>
							<td style="background-color: #DDEBF7;width: 70px;" align="right">'.number_format(str_replace('"', '', json_encode($tot3_3))).'</td>
						</tr>
		...
		if($i == count($items)-1){
			$message.= '<tr>
							<td style="background-color: #DDEBF7;width: 250px;" >SUB TOTAL ACTUAL LR#6 </td>
							<td style="background-color: #DDEBF7;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($Accum6))).'</td>
							<td style="background-color: #DDEBF7;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($daily6))).'</td>

							<td style="background-color: #DDEBF7;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($tot6_1))).'</td>
							<td style="background-color: #DDEBF7;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($tot6_2))).'</td>
							<td style="background-color: #DDEBF7;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($tot6_3))).'</td>
						</tr>
						';
		}
	}
...
$message.= '<tr>
							<td style="background-color: #D2D2D2;width: 250px;" >TOTAL ALL </td>
							
							<td style="background-color: #D2D2D2;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($Accum))).'</td>
							<td style="background-color: #D2D2D2;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($daily))).'</td>

							<td style="background-color: #D2D2D2;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($tot3_6_1))).'</td>
							<td style="background-color: #D2D2D2;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($tot3_6_2))).'</td>
							<td style="background-color: #D2D2D2;width: 100px;" align="right">'.number_format(str_replace('"', '', json_encode($tot3_6_3))).'</td>
						</tr>
...
if (intval($on_dt) <= 7){
	$mail->AddAttachment('D:\Program/LabelDailyReport/FileExcel/Label Comparison Report '.$$arrBln[intval(date('m'))-1].' send.xls');
	$mail->AddAttachment('D:\Program/LabelDailyReport/FileExcel/Label Comparison Report '.$on_month.' send.xls');
...
$mail->AddAttachment('C:\xampp/Kuraire/wms/schedule/label_mail_excel.xls');
