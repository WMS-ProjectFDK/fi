	...
	<div style:position:absolute;'>
		<table>
			...
			<tr>
				<td>ITEM NAME</td>
				<td>:</td>
				<td><div style='width: 242px;word-wrap: break-word;''>".mb_substr($data[1], 0,25)."</div></td>
			</tr>
			<tr>
				<td>TYPE</td>
				<td>:</td>
			...
			<tr>
				<td align='center' style='font-size:145px;'><b>".$data[5]."</b></td>
				<td></td>
				<td align='center'><qrcode value='".$data[8].','.$user_name."' ec='H' style=' border:none; width:131px;background-color: white; color: black;'></qrcode></td>
			</tr>
		</table>
	</div> ";
}
