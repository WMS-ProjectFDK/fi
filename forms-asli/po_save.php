	...
	foreach($queries as $query){
		...
		if ($po_sts == 'DETAILS') {
			...
			$stmt = oci_parse($connect, $sql);
			 ...
			 /*Binding Parameters */
			oci_bind_by_name($stmt, ':V_PO_NO' , trim($po_no));
...
//
		//if($msg != ''){
		//	$msg .= " MRP-Update Process Error : $sql2";
		//	break;
		//}
	}
}else{
...
//	$sql = "BEGIN ZSP_Insert_PO_1(:V_PO_NO,:V_SUPPLIER_CODE,:V_PO_DATE,:V_CURR_CODE,:V_EX_RATE,:V_TTERM,:V_PDAYS,:V_PDESC,:V_REQ,:V_REMARK1,:V_MARKS1,:V_AT//TN,:V_PERSON_CODE,:V_ITEM_NO,:V_PBY,:V_SHIPTO_CODE,:V_TRANSPORT,:V_DI_OUTPUT_TYPE,:V_PRF_NO,:V_PRF_LINE_NO,:V_ORIGIN_C//ODE,:V_QTY,:V_UOM_Q,:V_U_PRICE,:V_D_AMT_O,:V_D_AMT_L,:V_ETA,:V_SCHEDULE,:V_BAL_QTY,:V_CARVED_STAMP,:V_FROM,:V_TO); end;";
//
//	$stmt = oci_parse($connect, $sql);
//
//	
...
//	// 	$field_po .= "tterm,"          ; 	$value_2po .= "'$po_tterm',"						 ;
...
//	// }
//	
//	$sql = "BEGIN ZSP_MRP_MATERIAL_ITEM($po_item); END;";
//
//	$stmt = oci_parse($connect, $sql);
//	
//	$res = oci_execute($stmt);
