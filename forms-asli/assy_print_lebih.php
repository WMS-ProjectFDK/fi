...
while ($data=oci_fetch_object($result)){
	...
	$content.= "<div class=".$cls.">
					<table border=0 style='font-size:16px;width:100%;font-weight: bold;'>
								...
								<table border=1>
						            <tr>
						              ...
						              <td style='width:65px;border-color: #FFFFFF;' align='right' valign='middle'>
						              	<qrcode 
											value='".$ks.','.$data->ASYLINE.','.$ks.','.$data->QTY_BOX_PALLET.','.$data->QTY.','.$ks.','.$data->QTY_BOX.','.$id_plan.','.$data->ID."' 
						...
						<tr>
							<td colspan=2 valign='middle' style='height:5px;font-size:8px;'><b>* : KANBAN PLAN LEBIH</b></td>
