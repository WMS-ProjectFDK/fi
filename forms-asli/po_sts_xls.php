...
$qry = "select curr_mark,gg.gr_no,h.supplier_code,company, d.po_no, h.po_date, d.item_no, itm.description, line_no,d.eta, d.qty, d.gr_qty,gg.qty as Receipt_Qty, d.bal_qty,
    gg.gr_Date, c.accpac_company_code, to_char(d.eta,'yyyy-mm-dd') as etad, to_char(gg.gr_Date,'yyyy-mm-dd') as grd, d.eta - gg.gr_date as diff,d.u_price,itm.standard_price,d.amt_o, d.amt_l from po_header h
