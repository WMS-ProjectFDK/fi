<?php
	...
	$where = "where to_char(t.slip_date, 'YYYY-MM-DD') between '$date_awal' and '$date_akhir' ";

	$sql = "select c.BC_DOC_REVERSE as BC_DOC, t.bc_no, t.slip_date, t.slip_no, c.company customer, cu.curr_mark, sum(t.slip_amount) as slip_amount
		from transaction t
