...
<script type="text/javascript">
		...
		if(slip_no_add == 'UNDEFINED' || slip_date_add == '' || cmb_slip_type_add =='' || cmb_company_add == ''){
			...
			$.post('do_save.php',{
				...
				if(res == '"success"'){
					...
					$.post('do_destroy.php',{id: slip_no_add},'json');
	...
	function saveAdd(){
		...
		if (flag==1){
			alert("Transaction is in difference month, please make sure your transaction in the correct month but If you still need transaction in difference month. please contact accounting or Warehouse.");
		}else{
			var url='';
