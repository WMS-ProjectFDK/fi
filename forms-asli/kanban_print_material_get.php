<?php
	...
	$rs = "select st.lower_item_no as item_no,i.item,i.description item_name, 
		CEIL((round((quantity * $qty) / quantity_base,0) + 
		Ceil((quantity * $qty) / quantity_base  * failure_rate/100)) / nvl(bundle_qty,1)) * nvl(bundle_qty,1) 
		as QTY_REQ,nvl(zz.qty,0) QTY_ON_BOOK, nvl(w.this_inventory,0) as QTY_WAREHOUSE,
