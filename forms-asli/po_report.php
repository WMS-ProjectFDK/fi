...
<!DOCTYPE html>
	...
	*{
	...
	<div id='dlg_add' class="easyui-dialog" style="width:1100px;height:550px;padding:5px 5px;" closed="true" buttons="#dlg-buttons-add" data-options="modal:true">
		<fieldset style="border:1px solid #d0d0d0; border-radius:2px; width:1045px; float:left; margin:5px;"><legend> Select Supplier </legend>
			...
			<div class="fitem">
				...
				<input style="width:185px;" name="ship_add" id="ship_add" class="easyui-combobox"/>
		...
		<div id="dlg_prf_add" class="easyui-dialog" style="width: 880px;height: 270px;" closed="true" buttons="#dlg-buttons-prf_add" data-options="modal:true">
	...
	<div id='dlg_edit' class="easyui-dialog" style="width:1100px;height:550px;padding:5px 5px;" closed="true" buttons="#dlg-buttons-edit" data-options="modal:true">
		<fieldset style="border:1px solid #d0d0d0; border-radius:2px; width:1045px; float:left; margin:5px;"><legend> Select Supplier </legend>
			...
			<div class="fitem">
				...
				<span style="width:50px;display:inline-block;">Ship To</span>
				<input style="width:185px;" name="ship_edit" id="ship_edit" class="easyui-combobox" disabled="" />
				<span style="width:40px;display:inline-block;">Trade</span>
				<input style="width:142px;" name="trade_edit" id="trade_edit" class="easyui-textbox" disabled="" />
			</div>
		</fieldset>
		<fieldset style="border:1px solid #d0d0d0; border-radius:2px; width:1045px; float:left; margin:5px;"><legend>Create PO</legend>
			<div style="width:395px; height: 90px; float:left;">	
				<div class="fitem">
			...
			<div>
				...
				<div class="fitem">
					<input style="width: 205px; height: 56px;" name="remark_edit" id="remark_edit"  multiline="true" class="easyui-textbox"/>
					<input style="width: 205px; height: 56px;" name="shipp_mark_edit" id="shipp_mark_edit"  multiline="true" class="easyui-textbox"/>
	...
	<div id="toolbar">
		<fieldset style="border:1px solid #d0d0d0; border-radius:4px; width:950px; height:170px; float:left;"><legend>Purchase Order Filter</legend>
			<div style="width:470px; float:left;">
				...
				<div class="fitem">
					<span style="width:80px;display:inline-block;">GR No.</span>
					<select style="width:300px;" name="GR" id="GR" class="easyui-combobox" data-options=" url:'json/json_grno.php', method:'get', valueField:'gr_no', textField:'gr_no', panelHeight:'75px'"></select>
					<label><input type="checkbox" name="ck_GR" id="ck_GR" checked="true">All</input></label>
				</div>

				<div class="fitem">
					<span style="width:80px;display:inline-block;">PRF No.</span>
					<select style="width:300px;" name="PRF" id="PRF" class="easyui-combobox" data-options=" url:'json/json_prf_no.php',method:'get',valueField:'prf_no',textField:'prf_no', panelHeight:'150px'"></select>
			...
			<div>
				<div class="fitem">
					...
					<select style="width:330px;" name="cmb_item_no" id="cmb_item_no" class="easyui-combobox" data-options=" url:'json/json_item_material.php', method:'get', valueField:'id_item', textField:'id_name_item', panelHeight:'100px',
					onSelect:function(rec){
				...
				<div class="fitem">
					...
					<input style="width:100px;" name="date_eta" id="date_eta" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" value="<?date();?>"/>
					to
					<input style="width:85px;" name="date_eta_akhir" id="date_eta_akhir" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" value="<?date();?>"  />
					<label><input type="checkbox" name="ck_eta" id="ck_eta" checked="true">All</input></label>
				</div>
				<div class="fitem">
					<label><input type="checkbox" name="ck_endorder" id="ck_endorder" checked="false">View End Order</input></label>
				</div>
			</div>
		</fieldset>
		<fieldset style="border:1px solid #d0d0d0; border-radius:4px; height:170px; margin-left:965px;"><legend>Purchase Order Report</legend>
		  <div align="center">
		  ...
		  <div class="fitem" align="center">
			   <a href="javascript:void(0)" class="easyui-linkbutton c2" onclick="print_po_sts_xls()" iconCls="icon-excel" plain="true" style="width:285px"> Download PO Status</a>
			   
		  </div>

		    <div class="fitem" align="center">
			   
			  	<!-- <label><input type="checkbox" name="ck_det" id="ck_det" checked="true">Details</input></label> -->
			    <a href="javascript:void(0)" class="easyui-linkbutton c2" onclick="filterData2()" iconCls="icon-search" plain="true" style="width:285px"> View PO Status</a>
		  </div>
		</fieldset>
		...
		<div style="margin-top: 5px;margin: 5px;">
			...
			<a href="javascript:void(0)" style="width: 100px;" class="easyui-linkbutton c2" id="addPo" onclick="addPo()"><i class="fa fa-plus" aria-hidden="true"></i> Add PO</a>
			<a href="javascript:void(0)" style="width: 100px;" class="easyui-linkbutton c2" id="editPo" onclick="editPo()"><i class="fa fa-pencil" aria-hidden="true"></i> Edit PO</a>
			<a href="javascript:void(0)" style="width: 100px;" class="easyui-linkbutton c2" id="deletePo" onclick="destroyPo()"><i class="fa fa-trash" aria-hidden="true"></i> Delete PO</a>
			<a href="javascript:void(0)" style="width: 100px;" class="easyui-linkbutton c2" id="printPo" onclick="printPo()"><i class="fa fa-print" aria-hidden="true"></i> Print PO</a> -->
		</div>
	</div>
	<table id="dg" title="PURCHASE ORDER REPORT" toolbar="#toolbar" class="easyui-datagrid" style="width:100%;height:550px;"></table>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$('#date_eta_akhir').datebox('disable');
			...
			$('#dg').datagrid({
				...
				sortOrder: 'asc',
			    columns:[[
				    {field:'PO_NO',title:'PO NO.',width:100, halign: 'center', sortable:true},
				    {field:'PO_DATE',title:'PO DATE',width:85, halign: 'center', align: 'center', sortable:true},
				    {field:'COMPANY',title:'SUPPLIER',width:200, halign: 'center', sortable:true},
				    {field:'ITEM_NO',title:'ITEM No',width:80, halign: 'center', align:'right', sortable:true},
				    {field:'DESCRIPTION',title:'DESCRIPTION',width:80, halign: 'center', align: 'center',sortable:true},
				    {field:'LINE_NO',title:'LINE',width:30, halign: 'center', align:'right', sortable:true},
				    {field:'QTY',title:'QTY PURCH', width:80, halign: 'right'},

				    {field:'GR_QTY',title:'GR QTY', width:70, halign: 'right'},
				    {field:'BAL_QTY',title:'BAL QTY', width:70, halign: 'right'},
				    {field:'U_PRICE',title:'U PRICE',width:70, halign: 'right', align: 'left',sortable:true,},
				    {field:'STANDARD_PRICE',title:'STANDARD_PRICE',width:70, halign: 'right', align: 'left',sortable:true},
					{field:'CURR_MARK',title:'CURRENCY',width:70, halign: 'right', align: 'left',sortable:true},
				    {field:'AMT_O',title:'AMT ORG',width:70, halign: 'right', align: 'left',sortable:true},
				    {field:'AMT_L',title:'AMT LOC',width:70, halign: 'right', align: 'left',sortable:true},

				    {field:'GR_NO',title:'GR No',width:150, halign: 'center', align: 'left',sortable:true,},
				    {field:'RECEIPT_QTY',title:'RCPT QTY',width:70, halign: 'right', align: 'left',sortable:true},
				    {field:'ETAD',title:'ETA',width:110, halign: 'center', align: 'left',sortable:true},
				    {field:'GRD',title:'GR DATE',width:110, halign: 'center', align: 'left',sortable:true}
	   ...
	   //              });
		...
		function filterData(){
			...
			var ck_po='false';
			var ck_eta='false';
			var ck_endorder='false';
			var ck_PRF='false';
			var ck_det='false';


			if($('#ck_det').attr("checked")){
				ck_det='true';
			}
			...
			// 	date_eta_akhir: $('#date_eta_akhir').datebox('getValue'),
			// 	ck_eta: ck_eta,
			// 	src: '',
			// 	gr: $('#GR').combobox('getValue'),
			// 	ck_gr: ck_gr,
			// 	ck_endorder: ck_endorder,
			// 	prf: $('#PRF').combobox('getValue'),
			// 	ck_PRF: ck_PRF
			// });
		 ...
		 //   	$('#dg').datagrid('enableFilter');
		 	...
		 	//URL
		   	url_pdf ="?date_awal="+$('#date_awal').datebox('getValue')+"&date_akhir="+$('#date_akhir').datebox('getValue')+"&ck_date="+ck_date+"&supplier="+$('#supplier').combobox('getValue')+"&supplier_nm="+$('#supplier').combobox('getText')+"&ck_supplier="+ck_supplier+"&cmb_item_no="+$('#cmb_item_no').combobox('getValue')+"&ck_item_no="+ck_item_no+"&cmb_po="+$('#cmb_po_no').combobox('getValue')+"&ck_po="+ck_po+"&date_eta="+$('#date_eta').datebox('getValue')+"&ck_eta="+ck_eta+"&txt_item_name="+$('#txt_item_name').textbox('getValue')+"&GR="+$('#GR').combobox('getValue')+"&ck_GR="+ck_gr+"&date_eta_akhir="+$('#date_eta_akhir').datebox('getValue')+"&ck_endorder="+ck_endorder+"&prf="+$('#PRF').textbox('getValue')+"&ck_prf="+ck_PRF+"&ck_det="+ck_det;
		}
		...
		function filterData2(){
			...
			$('#dg').datagrid('load', {
		 	...
		 	//URL
		   	url_pdf ="?date_awal="+$('#date_awal').datebox('getValue')+"&date_akhir="+$('#date_akhir').datebox('getValue')+"&ck_date="+ck_date+"&supplier="+$('#supplier').combobox('getValue')+"&supplier_nm="+$('#supplier').combobox('getText')+"&ck_supplier="+ck_supplier+"&cmb_item_no="+$('#cmb_item_no').combobox('getValue')+"&ck_item_no="+ck_item_no+"&cmb_po="+$('#cmb_po_no').combobox('getValue')+"&ck_po="+ck_po+"&date_eta="+$('#date_eta').datebox('getValue')+"&ck_eta="+ck_eta+"&txt_item_name="+$('#txt_item_name').textbox('getValue')+"&GR="+$('#GR').combobox('getValue')+"&ck_GR="+ck_gr+"&date_eta_akhir="+$('#date_eta_akhir').datebox('getValue')+"&ck_endorder="+ck_endorder+"&prf="+$('#PRF').textbox('getValue')+"&ck_prf="+ck_PRF;
		}
		...
		function editPo(){
			...
			if (row){
				...
				$('#ship_edit').textbox('setValue',row.SHIPTO_CODE);
				...
				$('#dg_edit').datagrid({
				    ...
				    columns:[[
					    ...
					    {field:'UNIT', title:'UoM', halign: 'center', width:45, align:'center'},
					    {field:'COUNTRY', title:'ORIGN', halign: 'center', width:80,},
					    {field:'QTY', title:'PURCHASE<br/>QTY', align:'right', halign: 'center', width:70, editor:{type:'numberbox',options:{required:true,precision:0,groupSeparator:','}}},
		...
		function save_editPo(){
			...
			for(i=0;i<total;i++){
				...
				$.post('po_edit.php',{
					...
					po_remark: $('#remark_edit').textbox('getValue'),
					po_ship_mark: $('#shipp_mark_edit').textbox('getValue'),
					po_rev: ck_rev,
