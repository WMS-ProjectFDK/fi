...
<head>
<meta charset="UTF-8">
<title>Sales Plan From MPS</title>
...
<div id="toolbar" style="padding:3px 3px;">
	<fieldset style="float:left;width:1100px;border-radius:5px;height:100px;"><legend><span class="style3"><strong> Shipping Plan By MPS </strong></span></legend>
		<div style="width:500px;float:left">
			<div class="fitem">
				<span style="width:150px;display:inline-block;">Cargo Ready Date</span>
				<input style="width:105px;" name="date_awal" id="date_awal" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" value="<?date();?>"/> 
				to 
			...
			<div class="fitem">
				...
				<select style="width:250px;" name="cmb_prf_no" id="cmb_prf_no" class="easyui-combobox" data-options=" url:'json/json_prf_no.php',method:'get',valueField:'prf_no',textField:'prf_no', panelHeight:'150px'"></select>
			...
			<div class="fitem">
				...
				<select style="width:250px;" name="cmb_item_no" id="cmb_item_no" class="easyui-combobox" data-options=" url:'json/json_item_all.php', method:'get', valueField:'id_item', textField:'id_name_item', panelHeight:'100px'"></select>
			...
			<a href="javascript:void(0)" style="width: 150px;height: 35px;" id="create_po" class="easyui-linkbutton c2" onClick="create_po()"><i class="fa fa-floppy-o" aria-hidden="true"></i> Filter</a>
		</div>
		</div>
	</fieldset>
...
<!-- ADD -->
<div id='dlg_add' class="easyui-dialog" style="width:1100px;height:50px;padding:5px 5px;" closed="true" buttons="#dlg-buttons-add" data-options="modal:true">
...
<table id="dg" title="Create Shipping Plan" class="easyui-datagrid" toolbar="#toolbar	" style="width:100%;height:490px;" rownumbers="true" fitColumns="true" selectOnCheck= "true"></table>
				...
				if($('#dg').datagrid('getData').rows[i].ck=="TRUE"){
					...
					$('#dg_add').datagrid('insertRow',{
						...
						row: {
							...
							QTY: $('#dg').datagrid('getData').rows[i].REMAINDER_QTY,
