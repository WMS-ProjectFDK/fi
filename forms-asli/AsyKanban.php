		...
		<fieldset style="width:97%;border-radius:4px;height: 230px;">
			<div style="width:300px; float:left;">
				...
				<div class="fitem">
					...
					<input style="width:100px;" name="cmb_Line" id="cmb_Line" class="easyui-combobox" data-options="url:'json/json_AsyLine.php', method:'get', valueField:'assy_line', textField:'assy_line_2', panelHeight:'160px'" required="" />
				</div>
				<div class="fitem" style="width: 650px;">
					...
					<a href="javascript:void(0)" id="PrintBtn" class="easyui-linkbutton c2" onClick="Print_qc()" style="width:200px;" disabled = "true">Print Kanban QC Sample</a>
				</div>
			</div>
			<div>
				<div class="fitem">
