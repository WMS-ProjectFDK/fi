...
qty,
QTY_PRODUKSI,
        ceil(r.qty/ pi.pallet_unit_number) totalPallet, 
        ...
        ceil((case when (qty - (floor(r.qty/ pi.pallet_unit_number) * pi.pallet_unit_number)) = 0
         		   then pi.pallet_unit_number 
...
left outer join (select wo, nvl(count(*),0) as jum_wo from ztb_amazon_wo group by wo) amz on r.work_order = amz.wo
$where
