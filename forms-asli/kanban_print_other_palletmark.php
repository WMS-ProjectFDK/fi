...
$sql = "select a.po_no as path, a.work_order, a.batery_type, a.cell_grade, a.po_no,
	...
	-- 			case when length(a.po_line_no) > 1 then 
 	--     			to_number(substr(a.po_line_no,length(a.po_line_no)*-1,length(a.po_line_no)-1)) 
 	--   			else to_number(a.po_line_no) end = sod.line_no
 	inner join so_details sod on soh.so_no=sod.so_no and substr(a.po_line_no,0,1) = sod.line_no
