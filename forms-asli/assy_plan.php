		...
		<fieldset style="float:left;width:850px;border-radius:4px;height: 80px;"><legend><span class="style3"><strong>Assembly Plan Filter</strong></span></legend>
			<div style="width:350px; float:left;">
				...
				<div class="fitem">
					...
					<select style="width:60px;" name="cmb_rev" id="cmb_rev" class="easyui-combobox" style="width:142px;"  data-options="url:'json/json_revisi_plan_assy.php', method:'get', valueField:'revisi', textField:'revisi', panelHeight:'auto'"/></select>
