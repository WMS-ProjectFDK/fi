...
$sql_h = "select distinct a.id, a.wo_no, a.item_no, substr(a.brand,0,30) as brand, a.date_code, a.type_item, a.grade, 
	a.date_prod, a.qty_prod, a.plt_no, a.plt_tot, a.cr_date, st.level_no as bom_level
	from ztb_plan_m a
...
// 	a.date_prod, a.qty_prod, a.plt_no, a.plt_tot, a.cr_date, nvl(b.bom_level,0) as bom_level
// 	from ztb_plan_m a
// 	left join mps_header b on a.wo_no = b.work_order and a.item_no = b.item_no
// 	where user_id = '$user_name'
// 	order by plt_no asc";
...
while ($data=oci_fetch_object($result)){
	...
	if($data->ITEM_NO != '73012220'){
		$link2 = "http://172.23.225.85/wms/forms/qr_generate_material_datecode.php?id=".$data->ID;	
	}else{
		$link2 = '';
	}
