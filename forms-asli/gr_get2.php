<?php
	...
	if ($src !='') {
		...
		$where ="where $gr $supp $po $item to_char(a.gr_date,'YYYY-MM-DD') between '$date_awal' and '$date_akhir'";
	}
	
	include("../connect/conn.php");

	$sql = "select distinct a.gr_no, a.gr_date, to_char(a.gr_date,'yyyy-mm-dd') as gr_date_2, a.supplier_code, c.company, a.curr_code, to_char(a.ex_rate,'99,999,990.0000000') as ex_rate,
		a.pdays, a.pdesc, b.curr_short, a.remark, a.amt_o, to_char(a.amt_l,'99,999,990.00000') as amt_l
		from gr_header a
