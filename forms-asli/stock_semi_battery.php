...
<body>
<h2 align='center'>STOCK SEMI BATTERY

</h2>



<table id="dg" class="easyui-datagrid" style="width:100%;height:960px;" url= "stock_semi_battery_get.php" rownumbers="false"  fitColumns="true" 
...
<a href="stock_semi_battery_execute.php" align="right" style="width: 100px;" class="easyui-linkbutton c2" onclick="RefreshData();"><i class="fa fa-refresh" aria-hidden="true"></i>Refresh Data</a>
...
<script type="text/javascript">
	...
	function info_suspended(a,b){
		$('#dlg_info').dialog('open').dialog('setTitle','VIEW INFO BEFORE LABEL (TIPE: '+a+')');
		$('#dg_info').datagrid({
			url: 'stock_semi_battery_get_info_suspend.php?tipe='+a+'&jns='+b,
			singleSelect: true,
			rownumbers: true,
			fitColumns: true,
			showFooter: true,
