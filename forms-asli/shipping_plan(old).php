...
<div id="toolbar" style="padding:3px 3px;">
	...
	<div style="padding:5px 6px;">
		...
		<a href="javascript:void(0)" id="print_si" class="easyui-linkbutton c2" onClick="print_si()" style="width:200px;">
			<i class="fa fa-print" aria-hidden="true"></i> Print SI to Forwarder</a>
	</div>
</div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#dg').datagrid( {
			columns:[[
                ...
                {field:'BATERY_TYPE', title:'BATERY<br/>TYPE', halign:'center', align:'center', width:40},
                {field:'CELL_GRADE', title:'GRADE', halign:'center', align:'center', width:35},
	...
	function print_si(){
		...
		if(SIexp[0] == null || SIexp[1] == null){
			...
			window.open('invoice_print_si.php?si='+SIexp[0]+'&do='+SIexp[1]+'&si_sts=si');
		}
	}
	...
	function info_plan(a){
		...
		$('#dg_viewPln').datagrid({
			...
			rownumbers: true,
		    columns:[[
			    {field:'AM',title:'AMEND',width:80,align:'center',
	                formatter:function(value,row,index){
	                    if (row.editing){
			    ...
			    {field:'ITEM_NO', title:'ITEM NO.', width: 80, halign: 'center', align: 'center'},
			    {field:'ITEM_NAME', title:'DESCRIPTION', width: 300, halign: 'center'},
			    {field:'CR_DATE', title:'CR<br/>DATE', width: 80, halign: 'center',editor:{
			    																	type:'datebox',
			    																	options:{required:true,formatter:myformatter,parser:myparser}
			    																}},
			    {field:'ETA', title:'ETA', width: 80, halign: 'center',editor:{
			    																	type:'datebox'
			    																}},
			    {field:'ETD', title:'ETD', width: 80, halign: 'center', align: 'right',editor:{
			    																	type:'datebox',
			    																	options:{required:true,formatter:myformatter,parser:myparser}
			    																}},
			    {field:'EX_FACT', title:'EX FACT<br/>DATE', width:80, halign: 'center',editor:{
			    																	type:'datebox',
			    																	options:{required:true,formatter:myformatter,parser:myparser}
			    																}},
			    {field:'QTY', title:'QTY', width:100, halign: 'center', align: 'right',editor:{type:'textbox',options:{required:false,precision:0,groupSeparator:','}}},
			    {field:'ANSWER_NO', title:'ANSWER<br/>NO.', width: 80, halign: 'center'},
			    {field:'DEL',title:'DELETE',width:80,align:'center',
	                formatter:function(value,row,index){
