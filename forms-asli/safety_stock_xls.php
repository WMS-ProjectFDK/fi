...
// header('Content-Disposition: attachment; filename="SAFETY_STOCK.xlsx"');
...
$objWriter->save(str_replace( __FILE__,$_SERVER['DOCUMMENT_ROOT'].'D:\Program/FinishingReportCopy/SAFETY_STOCK.xls',__FILE__));
...
$mail->AddAttachment('D:\Program/FinishingReportCopy/SAFETY_STOCK.xls');
