...
/*$qry = "select a.line_no, a.item_no, c.description, a.qty, b.customer_po_no, b.work_no, 
	d.case_total, ceil(zs.pallet) as pallet, zs.carton, zs.box_pcs
	from do_details a
	...
	where a.do_no='$do' order by a.line_no asc";*/
