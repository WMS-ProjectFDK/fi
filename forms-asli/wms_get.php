<?php
	...
	$where ="where TO_char(a.gr_date,'YYYY-MM-DD')='$pd_periode_awal' and a.gr_no is not null";

	$rs = "select * from (
		select distinct a.gr_no,a.gr_date,b.line_no,a.supplier_code,c.company,b.item_no,d.description, b.qty, e.unit,
