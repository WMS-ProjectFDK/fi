...
<head>
<meta charset="UTF-8">
<title>BC UPLOAD RECEIVE-SPAREPARTS</title>
...
<?php include ('../ico_logout.php'); ?>
	<table id="dg" title="BC UPLOAD RECEIVE SPAREPARTS" class="easyui-datagrid" style="width:100%;height:auto;" toolbar="#toolbar" fitcolumns="true" rownumbers="true"></table>
	<div id="toolbar">
		<div class="fitem" style="padding: 3px 3px;display:inline-block;">
			<span style="display:inline-block;">GR DATE</span>
			...
			<a href="bc_gr_spareparts_excel.php" id="dowloadBtn" style="width:200px;display:inline-block;" class="easyui-linkbutton c2" disabled="true"><i class="fa fa-download" aria-hidden="true"></i> 
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#dg').datagrid({
			    columns:[[
				    ...
				    {field:'GR_DATE', halign:'center', title:'GR DATE',width:70, align:'center'},
				    {field:'GR_NO', halign:'center', title:'SLIP NO.',width:70},
		...
		function uploaddataNya(){
			...
			$('#upd').form('submit',{
				url: 'bc_gr_spareparts_upload.php',
				onSubmit: function(){
