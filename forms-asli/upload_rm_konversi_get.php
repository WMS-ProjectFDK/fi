<?php
	...
	$sql = "select * from (select a.assy_line, a.cell_type, a.item_no, c.description, a.konversi, b.min_days, b.average, b.max_days from ztb_material_konversi a
		left join ztb_config_rm b on a.item_no=b.item_no
		left join item c on a.item_no= c.item_no
		$where
		order by a.item_no, a.assy_line, a.cell_type asc) where rownum <=200";
