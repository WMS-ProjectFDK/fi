...
$sql1 = "select item_desc, min, max, std, jum_item, item_no, avg,
    case when xx.jum_item = '1' then (select standard_price from item where item_no=xx.item_no) else 0 end standard_price,
    ...
    from (
        select item_desc, min, max, std, jum_item,
        case when jum_item = '1' then 
        (select item_no from ztb_config_rm where tipe=item_desc) 
        else '-' end item_no,
        ceil((n_1+n_2+n_3+n_4+n_5+n_6+n_7+n_8+n_9+n_10+
        n_11+n_12+n_13+n_14+n_15+n_16+n_17+n_18+n_19+n_20+
        n_21+n_22+n_23+n_24+n_25+n_26+n_27+n_28+n_29+n_30+
        n_31+n_32+n_33+n_34+n_35+n_36+n_37+n_38+n_39+n_40+
        n_41+n_42+n_43+n_44+n_45+n_46+n_47+n_48+n_49+n_50+
        ...
        from
        (
            select distinct item_desc, min, max, average as std, count (distinct item_no) as jum_item,
                    ceil((n_1+n_2+n_3+n_4+n_5+n_6+n_7+n_8+n_9+n_10+
                              n_11+n_12+n_13+n_14+n_15+n_16+n_17+n_18+n_19+n_20+
                              n_21+n_22+n_23+n_24+n_25+n_26+n_27+n_28+n_29+n_30+
                              n_31+n_32+n_33+n_34+n_35+n_36+n_37+n_38+n_39+n_40+
                ...
                n_1, n_2, n_3, n_4, n_5, n_6, n_7, n_8, n_9, n_10,
                         ...
                         n_81, n_82, n_83, n_84, n_85, n_86, n_87, n_88, n_89, n_90
                    from (
                    select distinct a.item_type as item_desc, b.item_no,
                    nvl(ceil(a.n_1),0) n_1, nvl(ceil(a.n_2),0) n_2, nvl(ceil(a.n_3),0) n_3, nvl(ceil(a.n_4),0) n_4, nvl(ceil(a.n_5),0) n_5, 
                ...
                nvl(ceil(a.n_86),0) n_86, nvl(ceil(a.n_87),0) n_87, nvl(ceil(a.n_88),0) n_88, nvl(ceil(a.n_89),0) n_89, nvl(ceil(a.n_90),0) n_90
                    from zvw_mrp_head a
                    left join ztb_mrp_data b on a.item_type = b.item_type) aa
                    left outer join 
                    (
                    ...
                    left OUTER join
                    (
                    select tipe, average from ztb_config_rm
    ...
    group by item_desc, min, max, avg, std, jum_item, item_no,
    n_1, n_2, n_3, n_4, n_5, n_6, n_7, n_8, n_9, n_10,
    n_11, n_12, n_13, n_14, n_15, n_16, n_17, n_18, n_19, n_20,
    n_21, n_22, n_23, n_24, n_25, n_26, n_27, n_28, n_29, n_30,
    n_31, n_32, n_33, n_34, n_35, n_36, n_37, n_38, n_39, n_40,
...
header('Content-Disposition: attachment; filename="MRP-'.date('Y-m-d').'.xls"');
