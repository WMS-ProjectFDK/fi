    ...
    <body>
        <!-- <div class="container" id="monitor"> -->
            ...
            <table class="table1" align="center">
                ...
                <tbody>
                    ...
                    <tr>
                    <!-- UPDATE TROUBLE -->
                        <th scope="row">TROUBLE</th><!-- <span class="check"> -->
                        <!-- <td style="font-size: 8px; color: #000000;"><div id="trouble_lr01_1"></div></td> --><!-- trouble_lr01_1 -->
                        <td style="font-size: 8px; color: #800000;"><div id="trouble_lr03_1"></div></td><!-- trouble_lr03_1 -->
                        <td style="font-size: 8px; color: #FF0000;"><div id="trouble_lr03_2"></div></td><!-- trouble_lr03_2 -->
                        <!-- <td style="font-size: color: #00AAFF; 8px;"><div id="trouble_lr03_3"></div></td> -->
                        <td style="font-size: 8px; color: #FFAA00;"><div id="trouble_lr06_1"></div></td><!-- trouble_lr06_1 -->
                        <td style="font-size: 8px; color: #FFFF00;"><div id="trouble_lr06_2"></div></td><!-- trouble_lr06_2 -->
                        <td style="font-size: 8px; color: #00FF00;"><div id="trouble_lr06_3"></div></td><!-- trouble_lr06_3 -->
                        <td style="font-size: 8px; color: #0000FF;"><div id="trouble_lr06_4"></div></td><!-- trouble_lr06_4 -->
                        <!-- <td style="font-size: 8px; color: #AA00FF;"><div id="trouble_lr06_5"></div></td> --><!-- trouble_lr06_5 -->
                        <td style="font-size: 8px; color: #00FFFF;"><div id="trouble_lr06_6"></div></td><!-- trouble_lr06_6 -->
                    </tr>
                    <!--  -->
                    <tr>
            ...
            <div class="example1" id="trouble_run">
            </div>
        <!-- </div> -->
        <script type="text/javascript">
            ...
            $(function(){
                ...
                //var lr3_3 = setInterval(function(){ my_lr3_3() }, 1000);
                ...
                var slide = setInterval(function(){ my_slide() }, 1000);
                /*setTimeout(function(){
            ...
            function my_slide(){
                $.ajax({
                    type: 'GET',
                    url: 'view_trouble_slide.php',
                    dataType: 'json',
                    success: function(data){
                        document.getElementById("trouble_run").innerHTML = data[0].ng_slide;
                    }
                });
            }
            ...
            /*function my_lr1_1(){
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data[0].trouble != '') {
                            document.getElementById("trouble_lr01_1").innerHTML = "<span></span>";
                        }else{
                            document.getElementById("trouble_lr01_1").innerHTML = "<span class='check'></span>";
                        }
            ...
            function my_lr3_1(){
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data[0].trouble == '') {
                            document.getElementById("trouble_lr03_1").innerHTML = "<span></span>";
                        }else{
                            document.getElementById("trouble_lr03_1").innerHTML = "<span class='check'></span>";
                        }
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data[0].trouble == '') {
                            ...
                            document.getElementById("trouble_lr03_2").innerHTML = "<span class='check'></span>";
                        }
            ...
            /*function my_lr3_3(){
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data[0].trouble == '') {
                            document.getElementById("trouble_lr03_3").innerHTML = "<span></span>";
                        }else{
                            document.getElementById("trouble_lr03_3").innerHTML = "<span class='check'></span>";
                        }
            ...
            function my_lr6_1(){
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data[0].trouble == '') {
                            document.getElementById("trouble_lr06_1").innerHTML = "<span></span>";
                        }else{
                            document.getElementById("trouble_lr06_1").innerHTML = "<span class='check'></span>";
                        }
            ...
            function my_lr6_2(){
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data[0].trouble == '') {
                            document.getElementById("trouble_lr06_2").innerHTML = "<span></span>";
                        }else{
                            document.getElementById("trouble_lr06_2").innerHTML = "<span class='check'></span>";
                        }
            ...
            function my_lr6_3(){
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data[0].trouble == '') {
                            document.getElementById("trouble_lr06_3").innerHTML = "<span></span>";
                        }else{
                            document.getElementById("trouble_lr06_3").innerHTML = "<span class='check'></span>";
                        }
            ...
            function my_lr6_4(){
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data[0].trouble == '') {
                            document.getElementById("trouble_lr06_4").innerHTML = "<span></span>";
                        }else{
                            document.getElementById("trouble_lr06_4").innerHTML = "<span class='check'></span>";
                        }
            ...
            /*function my_lr6_5(){
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data[0].trouble == '') {
                            document.getElementById("trouble_lr06_5").innerHTML = "<span></span>";
                        }else{
                            document.getElementById("trouble_lr06_5").innerHTML = "<span class='check'></span>";
                        }
            ...
            function my_lr6_6(){
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data[0].trouble == '') {
                            document.getElementById("trouble_lr06_6").innerHTML = "<span></span>";
                        }else{
                            document.getElementById("trouble_lr06_6").innerHTML = "<span class='check'></span>";
                        }
