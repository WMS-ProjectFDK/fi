...
<body>
	<div class="fitem" align="center">
		<span style="display:inline-block;font-size: 25px;font-weight: bold;">REALTIME MONITORING STOP TIME ASSEMBLY LINE LR6#3</span> 
	</div>
	...
	<div id="toolbar" align="left">
		<fieldset style="width:auto;height: 265px;border-radius:3px;">
			...
			<div align="left">
				...
				<div style="width:142px;height: 30px;display:inline-block;text-align:center;vertical-align: middle;background-color: #00AAFF;" id="1">
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('1')"><b>MOULD RING</b></a>
				</div>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF;margin-left: 2px;" id="2"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('2')"><b>CAN SUPPLY</b></a>
				</div>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;"  id="3">
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('3')"><b>MIX INSERT</b></a> 
				</div>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;"  id="4">
					 <a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('4')"><b>BEADING</b></a>
				</div>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;"  id="5">
				 	<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('5')"><b>ADHESIVE</b></a>
				 </div>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="6"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('6')"><b>SEPARATOR INSERT</b></a>
				</div>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="7"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('7')"><b>ELECTROLYTE FILLING</b></a>
				</div>
			</div>	
			<div align="left">
				<span  style="width:200px;display:inline-block;font-size: 20px;font-weight: bold;">Stop Time :</span>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="MOULD"> </input>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="CANSUPPLY"> </input>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="MIXINSERT"> </input>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="BEADING"> </input>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="ADHESIVE"> </input>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="SEPARATORINSERT"> </input>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="ELECFILLING"> </input>
			</div>
			<hr>
			...
			<span  style="width:198px;display:inline-block;font-size: 20px;font-weight: bold;">Process name :</span>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="8"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('8')"><b>TRAY STOCK</b></a>
				</div>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="9"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('9')"><b>VACUUM</b></a>
				</div>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="10"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('10')"><b>ANODE GEL</b></a>
				</div>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="11"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('11')"><b>UNCASER</b></a>
				</div>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="12"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('12')"><b>CCA-CURL-DRAW</b></a>
				</div>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="13">
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('13')"><b>WEIGHT CHECK</b></a>
				</div>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="14">
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('14')"><b>CASING LOADER</b></a>
				</div>
			</div>
			<div align="left">
				<span  style="width:200px;display:inline-block;font-size: 20px;font-weight: bold;">Stop Time :</span>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="TRAYSTOCK"> </input>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="VACUUM"> </input>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="ANODEGEL"> </input>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="UNCASER"> </input>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="CCAINSERT"> </input>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="WEIGHTCHECKER"> </input>
				<input type="text" style="width:140px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="CASINGLOAD"> </input>
			</div>
			<hr>
			<div align="left">
...
<script type="text/javascript">
	...
	$('#dg').datagrid({
		url : '_getPartOrder.php?line=LR6-3'
	});
	...
	function machine(mach){
		var url = '_getPartAll.php?id_machine='+mach+'&line=LR6-3';
	...
	function myTimer0(){
		$.ajax({
			type: 'GET',
			dataType: "json",
			url: 'json_view_monitoring.php?line=LR6-3'
		});
	}
	...
	function myTimer(){
		...
		$.ajax({
			type: 'GET',
			dataType: "json",
			url: 'json_view_output.php?line=LR6-3',
			data: data,
			success: function (data) {
