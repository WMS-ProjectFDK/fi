...
<body>
	<div class="fitem" align="center">
		<span style="display:inline-block;font-size: 25px;font-weight: bold;">REALTIME MONITORING STOP TIME ASSEMBLY LINE LR03#1</span> 
	</div>
		...
		<fieldset style="width:auto;height: 265px;border-radius:3px;">
			...
			<div align="left">
				...
				<div style="width:127px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="8"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('8')"><b>JIG STOCK</b></a>
				</div>
			</div>	
			<div align="left">
			...
			<span  style="width:198px;display:inline-block;font-size: 20px;font-weight: bold;">Process name :</span>
				...
				<div style="width:127px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="12"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('12')"><b>CCA INSERT</b></a>
				</div>
				<div style="width:127px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="13"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('13')"><b>CURLING</b></a>
				</div>
				<div style="width:127px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="14"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('14')"><b>WEIGHT CHECK</b></a>
				</div>
				<div style="width:127px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="15">
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('15')"><b>CASING LOADER</b></a>
				</div>
			</div>	
			<div align="left">
				<span  style="width:200px;display:inline-block;font-size: 20px;font-weight: bold;">Stop Time :</span>
				...
				<input type="text" style="width:125px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="UNCASER"> </input>
...
<script type="text/javascript">
	...
	function machine(mach){
		var url = '_getPartAll.php?id_machine='+mach+'&line=LR03-1';
	...
	function myTimer0(){
		$.ajax({
			type: 'GET',
			dataType: "json",
			url: 'json_view_monitoring.php?line=LR03-1'
		});
	}
	...
	function myTimer(){
					...
					var chart = new CanvasJS.Chart("chartContainer", {
						...
						data: [{
							...
							dataPoints: [
								...
								{label: "CCA_INSERT", y: parseInt(data[0].T_CCA_INSERT)},
		...
		$.ajax({
			type: 'GET',
			dataType: "json",
			url: 'json_view_output.php?line=LR03-1',
			data: data,
			success: function (data) {
