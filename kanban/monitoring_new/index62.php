...
<body>
	<div class="fitem" align="center">
		<span style="display:inline-block;font-size: 25px;font-weight: bold;">REALTIME MONITORING STOP TIME ASSEMBLY LINE LR6#2</span> 
	</div>
	...
	<div id="toolbar" align="left">
		<fieldset style="width:auto;height: 265px;border-radius:3px;">
			...
			<div align="left">
				...
				<div style="width:142px;height: 30px;display:inline-block;text-align:center;vertical-align: middle;background-color: #00AAFF;margin-left: 0px;" id="1">
			...
			<span  style="width:200px;display:inline-block;font-size: 20px;font-weight: bold;">Process name :</span>
				...
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="12"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('12')"><b>WEIGHT CHECK</b></a>
				</div>
				<div style="width:142px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="13">
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('13')"><b>CASING LOADER</b></a>
				</div>
			</div>	
			<div align="left">
				<span  style="width:202px;display:inline-block;font-size: 20px;font-weight: bold;">Stop Time :</span>
...
<script type="text/javascript">
	...
	$('#dg').datagrid({
		url : '_getPartOrder.php?line=LR6-2'
	});
	...
	function machine(mach){
		var url = '_getPartAll.php?id_machine='+mach+'&line=LR6-2';
	...
	function myTimer0(){
		$.ajax({
			type: 'GET',
			dataType: "json",
			url: 'json_view_monitoring.php?line=LR6-2'
		});
	}
	...
	function myTimer(){
		...
		$.ajax({
			type: 'GET',
			dataType: "json",
			url: 'json_view_output.php?line=LR6-2',
			data: data,
			success: function (data) {
