...
<body>
	<div class="fitem" align="center">
		<span style="display:inline-block;font-size: 25px;font-weight: bold;">REALTIME MONITORING STOP TIME ASSEMBLY LINE LR6#6</span> 
	</div>
	...
	<div id="toolbar" align="left">
		<fieldset style="width:auto;height: 265px;border-radius:3px;">
			...
			<div align="left">
				...
				<div style="width:147px;height: 30px;display:inline-block;text-align:center;vertical-align: middle;background-color: #00AAFF;margin-left: 0px;" id="1">
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('1')"><b>MOULD RING 1</b></a>
				</div>
				<div style="width:147px;height: 30px;display:inline-block;text-align:center;vertical-align: middle;background-color: #00AAFF;margin-left: 2px;" id="2">
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('2')"><b>MOULD RING 2</b></a>
				</div>
				<div style="width:147px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF;margin-left: 2px;" id="3"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('3')"><b>MIX INSERT</b></a>
				</div>
				<div style="width:147px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;"  id="4">
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('4')"><b>BEADING</b></a> 
				</div>
				<div style="width:147px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;"  id="5">
					 <a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('5')"><b>ADHESIVE</b></a>
				</div>
				<div style="width:147px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;"  id="6">
				 	<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('6')"><b>ELECTROLYTE</b></a>
				</div>
			</div>	
			<div align="left">
				<span  style="width:200px;display:inline-block;font-size: 20px;font-weight: bold;">Stop Time :</span>
				<input type="text" style="width:145px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="MOULD1"> </input>
				<input type="text" style="width:145px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="MOULD2"> </input>
				<input type="text" style="width:145px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="MIXINSERT"> </input>
				<input type="text" style="width:145px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="BEADING"> </input>
				<input type="text" style="width:145px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="ADHESIVE"> </input>
				<input type="text" style="width:145px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="ELECFILLING"> </input>
			</div>
			<hr>
			...
			<span  style="width:198px;display:inline-block;font-size: 20px;font-weight: bold;">Process name :</span>
				<div style="width:147px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="7"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('7')"><b>JIG STOCK</b></a>
				</div>
				<div style="width:147px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="8"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('8')"><b>GEL DRAWING</b></a>
				</div>
				<div style="width:147px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="9"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('9')"><b>WEIGHT CHECK</b></a>
				</div>
				<div style="width:147px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="10"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('10')"><b>CASING LOADER</b></a>
				</div>
				<div style="width:147px;height: 30px;display:inline-block;text-align: center;vertical-align: middle;background-color: #00AAFF; margin-left: 2px;" id="11"> 
					<a href="#" style="font-size: 20px;text-decoration: none; color: black;" onclick="machine('11')"><b>PALLETING</b></a>
				</div>
			</div>	
			<div align="left">
				<span  style="width:200px;display:inline-block;font-size: 20px;font-weight: bold;">Stop Time :</span>
				<input type="text" style="width:145px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="JIGSTOCK"> </input>
				<input type="text" style="width:145px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="GELDRAW"> </input>
				<input type="text" style="width:145px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="WEIGHTCHECKER"> </input>
				<input type="text" style="width:145px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="CASINGLOAD"> </input>
				<input type="text" style="width:145px;height: 30px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" id="PALLETING"> </input>
			</div>
			<hr>
			<div align="left">
...
<script type="text/javascript">
	...
	$('#dg').datagrid({
		url : '_getPartOrder.php?line=LR6-6'
	});
	...
	function machine(mach){
		var url = '_getPartAll.php?id_machine='+mach+'&line=LR6-6';
	...
	function myTimer0(){
		$.ajax({
			type: 'GET',
			dataType: "json",
			url: 'json_view_monitoring.php?line=LR6-6'
		});
	}
	...
	function myTimer(){
				...
				if (loop  > 4){
					...
					var chart = new CanvasJS.Chart("chartContainer", {
						...
						data: [{
							...
							indexLabel: "{y}",
							dataPoints: [
								{label: "MOULD RING 1", y: parseInt(data[0].T_MOULDING1)},
								{label: "MOULD RING 2", y: parseInt(data[0].T_MOULDING2)},
		...
		$.ajax({
			type: 'GET',
			dataType: "json",
			url: 'json_view_output.php?line=LR6-6',
			data: data,
			success: function (data) {
