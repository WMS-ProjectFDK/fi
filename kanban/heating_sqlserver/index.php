<?php include("../../connect/conn_kanbansys.php"); ?>
<!DOCTYPE html>
    <html>
    <head>
    <meta charset="UTF-8">
	...
	*{
    ...
    <body>
		<div id="p" class="easyui-panel" title="HEATING KANBAN SYSTEM" data-options="iconCls:'icon-save', tools:'#tt', footer:'#footer'" style="width:100%;height:600px;padding:5px;">
			...
			<div style="margin-top: 190px;" align="center">
				<!-- <div style="float:left;width:650px;">
					<table id="dg_line" title="Accumulation" class="easyui-datagrid" style="width:650px;height:330px;border-radius:4px;"></table>
				</div> -->
				<div align="center">
		...
		<script type="text/javascript">
			...
			function table_proses(){
				/*$('#dg_line').datagrid('loaded');
				$('#dg_line').datagrid( {
					url: 'heat_line_get.php'
				});*/
			...
			/*$('#dg_line').datagrid( {
				...
				rownumbers: true,
			    columns:[[
	                {field:'ASSY_LINE',title:'ASSEMBLY<br>LINE',width:80,halign:'center', rowspan:2},
	                {field:'CELL_TYPE',title:'CELL TYPE',width:80,halign:'center', rowspan:2},
	                {title:'HEATING ROOM',width:200,halign:'center', colspan:2},
	                {title:'AGING AREA',width:200,halign:'center', colspan:2}
				],
				[
					{field:'QTY_IN',title:'PCS',width:100,halign:'center', align:'right'},
					{field:'BOX_IN',title:'BOX',width:100,halign:'center', align:'right'},
					{field:'QTY_OUT',title:'PCS',width:100,halign:'center', align:'right'},
					{field:'BOX_OUT',title:'BOX',width:100,halign:'center', align:'right'}
				]]
			});*/
