<!DOCTYPE html>
    ...
    <body onload="disableTest();">
		<div id="p" class="easyui-panel" title="PRODUCTION ANODE GEL" data-options="iconCls:'icon-save', tools:'#tt', footer:'#footer'" style="width:100%;">
			...
			<!-- <div align="center" id="list_table" style="width:650px;margin-left: 230px;"></div> -->
			</form>
		...
		if(isset($_POST['submit'])){
			if (! $connect){
				...
				$field .= "DATE_USE = to_date('".date('Y-m-d H:i:s')."','yyyy-mm-dd hh24:mi:ss')" 	;
				...
				$upd = "update ztb_assy_anode_gel_sts set flag = 0, pemakaian_assy = 1, no_tag=''
				...
				if($data_upd){
					...
					echo "<script type='text/javascript'>alert('UPDATE DATA FAILED');self.location.href = 'anode_gel_assy.php';</script>";
				}
			}
		}
		?>
