    ...
    <body>
		<div id="p" class="easyui-panel" title="UNSUSPEND KANBAN SYSTEM" data-options="iconCls:'icon-save', tools:'#tt', footer:'#footer'" style="width:100%;height:655px;padding:5px;">
			<fieldset style="position: absolute; float: left;margin-left:5px;border-radius:4px;width: 43%;height: 570px;"><legend><span class="style3"><strong>UNSUSPEND TRANSACTION</strong></span></legend>
				...
				<br/>
				 <div class="fitem" style="padding: 5px;">
					<span style="width:25%;display:inline-block;font-weight: bold;">SUSPEND BATTERY</span>
					<span style="width:25%;display:inline-block;font-weight: bold;">CARD</span>
				</div>
				<div class="fitem" style="padding: 5px;">
				...
				<div class="fitem" style="padding: 5px;" align="center">
					<a id="savebtn_Plan" class="easyui-linkbutton c2" onClick="proses()" style="width:150px; height: 41px;display:inline-block;"><i class="fa fa-save" aria-hidden="true"></i> PROCCESS</a>
					<a id="savebtn_Plan" class="easyui-linkbutton c5" onClick="cancel()" style="width:150px; height: 41px;display:inline-block;"><i class="fa fa-remove" aria-hidden="true"></i> CANCEL</a>
					<a href="http://localhost/wms/kanban/qc/" class="easyui-linkbutton c2" style="width:150px; height: 41px;display:inline-block;"><i class="fa fa-undo" aria-hidden="true"></i> BACK TO MENU</a>
				</div>
				<br/><hr>
