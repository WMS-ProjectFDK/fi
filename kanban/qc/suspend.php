<!DOCTYPE html>
    ...
    <head>
    <meta charset="UTF-8">
    <title>Suspend Kanban System</title>
    ...
    <body>
		<div id="p" class="easyui-panel" title="SUSPEND KANBAN SYSTEM" data-options="iconCls:'icon-save', tools:'#tt', footer:'#footer'" style="width:100%;height:655px;padding:5px;">
			<fieldset style="float: left;margin-left:5px;border-radius:4px;width: 43%;height: 570px;"><legend><span class="style3"><strong>SUSPEND TRANSACTION</strong></span></legend>
				...
				<div class="fitem" style="padding: 5px;" align="center">	
					<input style="width:555px; height: 40px; border: 1px solid #0099FF;border-radius: 5px;font-size: 30px;" 
				...
				<hr>
				<div class="fitem" style="padding: 5px;" align="center">
					<a id="savebtn_Plan" class="easyui-linkbutton c2" onClick="proses()" style="width:150px; height: 41px;display:inline-block;"><i class="fa fa-save" aria-hidden="true"></i> SUSPEND</a>
					<a id="savebtn_Plan" class="easyui-linkbutton c5" onClick="cancel()" style="width:150px; height: 41px;display:inline-block;"><i class="fa fa-trash" aria-hidden="true"></i> CANCEL</a>
