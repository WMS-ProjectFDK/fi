...
<!DOCTYPE html>
    ...
    <body>
		<div style="width:auto;height:auto;padding:5px;">
			...
			<div align="center">
				<div align="center" id="list_table" style="width:600px;"></div>
				 <div align="left" style="width:100%;">
					<fieldset style="float:left;width:45%;height: 300px;border-radius:4px;"><legend><span class="style3"><strong>VIEW</strong></span></legend>
						<div class="fitem">
					...
					<fieldset style="position:absolute;margin-left:46%;border-radius:4px;width: 50%; height: 300px;"><legend><span class="style3"><strong>COMPOSITION</strong></span></legend>
						<div class="fitem">
							<span style="width:150px;display:inline-block;">Material</span>
							<span style="width:100px;display:inline-block;">Qty (Kg)<br>Standar</span>
							<span style="width:25px;display:inline-block;"></span>
							<span style="width:180px;display:inline-block;">Qty (Kg)<br>Actual</span>
							<span style="width:35px;display:inline-block;"></span>
							<span style="width:100px;display:inline-block;">No. Lot<br>Material</span>
						</div>
						<div class="fitem">
							...
							<span style="width:235px;display:inline-block;"></span>
							<input type="text" style="width:140px;" name="lot_zn" id="lot_zn" required=""/>
						</div>
						<div class="fitem">
							...
							<span style="width:25px;display:inline-block;"></span>
							<input  type="number" style="width:80px;text-align:right;" name="qty_aquapec_act" id="qty_aquapec_act" step="0.01" min="0" value="0" readonly=""/>
							<input type="button" style="width: 100px;" id="tmbng_hv505_hc" name="tmbng_hv505_hc" onclick="klik_tmbng_hv505_hc()" value="AMBIL DATA" />
							<span style="width:15px;display:inline-block;"></span>
							<input type="text" style="width:140px;" name="lot_aquapec" id="lot_aquapec" required=""/>
						</div>
						<div class="fitem">
							...
							<span style="width:25px;display:inline-block;"></span>
							<input  type="number" style="width:80px;text-align:right;" name="qty_pw_act" id="qty_pw_act" step="0.01" min="0" value="0" readonly=""/>
							<input type="button" style="width: 100px;" id="tmbng_hv501_e" name="tmbng_hv501_e" value="AMBIL DATA" onclick="klik_tmbng_hv501_e()"/>
							<span style="width:15px;display:inline-block;"></span>
							<input type="text" style="width:140px;" name="lot_pw" id="lot_pw" required=""/>
						</div>
						<div class="fitem">
							...
							<span style="width:25px;display:inline-block;"></span>
							<input  type="number" style="width:80px;text-align:right;" name="qty_aqupec2_act" id="qty_aqupec2_act" step="0.01" min="0" value="0" readonly=""/>
							<input type="button" style="width: 100px;" id="tmbng_hv505_e" name="tmbng_hv505_e" value="AMBIL DATA" onclick="klik_tmbng_hv505_e()"/>
							<span style="width:15px;display:inline-block;"></span>
							<input type="text" style="width:140px;" name="lot_aqupec2" id="lot_aqupec2" required=""/>
						</div>
						<div class="fitem">
							...
							<span style="width:25px;display:inline-block;"></span>
							<input  type="number" style="width:80px;text-align:right;" name="qty_th_act" id="qty_th_act" step="0.01" min="0" value="0" readonly=""/>
							<input type="button" style="width: 100px;" id="tmbng_th_1758" name="tmbng_th_1758" value="AMBIL DATA" onclick="klik_tmbng_th_1758()"/>
							<span style="width:15px;display:inline-block;"></span>
							<input type="text" style="width:140px;" name="lot_th" id="lot_th" required=""/>
						</div>
						<div class="fitem">
		    				<span style="width:150px;display:inline-block;v">Keterangan</span>
		    				<textarea name="ket" id="ket" cols="58" rows="2" readonly=""></textarea>
		    			</div>
					</fieldset>
				</div>
			</div>
			...
			function proses(){
	    		$.ajax({
					...
					success: function(data){
						...
						document.getElementById('tmbng_hv505_hc').disabled = false;

						if(data[0].aquapec == 0){
							document.getElementById('tmbng_hv505_hc').disabled = true;
						}
						
						if(data[0].pw150 == 0){
							document.getElementById('tmbng_hv501_e').disabled = true;
						}

						if(data[0].aqupec2 == 0){
							document.getElementById('tmbng_hv505_e').disabled = true;
						}
						
						if(data[0].th175b == 0){
							document.getElementById('tmbng_th_1758').disabled = true;
						}
					}
				});
			}

			function klik_tmbng_hv505_hc(){
				$.ajax({
					type: 'GET',
					url: 'json_timbangan.php',
					data: { kode:'kode' },
					success: function(data){
						document.getElementById("qty_aquapec_act").value = data[0].VALUE;
					}
				});
			}

			function klik_tmbng_hv501_e(){
				$.ajax({
					type: 'GET',
					url: 'json_timbangan.php',
					data: { kode:'kode' },
					success: function(data){
						document.getElementById("qty_pw_act").value = data[0].VALUE;
					}
				});
			}

			function klik_tmbng_hv505_e(){
				$.ajax({
					type: 'GET',
					url: 'json_timbangan.php',
					data: { kode:'kode' },
					success: function(data){
						document.getElementById("qty_aqupec2_act").value = data[0].VALUE;
					}
				});
			}

			function klik_tmbng_th_1758(){
				$.ajax({
					type: 'GET',
					url: 'json_timbangan.php',
					data: { kode:'kode' },
					success: function(data){
						document.getElementById("qty_th_act").value = data[0].VALUE;
					}
				});
			}
		...
		<?php
			if(isset($_POST['submit'])){
				if (! $connect){
					...
					$lot_pw = $_POST['lot_pw'];
					$lot_aqupec2 = $_POST['lot_aqupec2'];
					$lot_th = $_POST['lot_th'];
					$qty_aqupec= $_POST['qty_aquapec_act'];
					$qty_pw150 = $_POST['qty_pw_act'];
					$qty_aqupec2= $_POST['qty_aqupec2_act'];
					$qty_th175b = $_POST['qty_th_act'];
					...
					if($type_gel == '' AND $type_zn == '' AND $kanban_no == ''){
						...
						$field .= "lot_aqupec2 = '$lot_aqupec2'," 		;
						$field .= "lot_th175B = '$lot_th',"				;
						$field .= "upto_date_drymix = GETDATE(),"		;
						$field .= "act_qty_aqupec = '$qty_aqupec',"		;
						$field .= "act_qty_pw150 = '$qty_pw150',"		;
						$field .= "act_qty_aqupec2 = '$qty_aqupec2',"	;
						$field .= "act_qty_th175b = '$qty_th175b'"		;
						chop($field);
						...
						if($data_upd){
							...
							echo "<script type='text/javascript'>alert('INSERT DATA FAILED <br>".$upd."');</script>";
						}
					}
				}
			}
