    ...
    <body>
		...
		<?php
			if(isset($_POST['submit'])){
				...
				$cek = "select count(*) from ztb_assy_anode_gel_sts where flag=1 AND pemakaian_assy = 0";
				...
				if($type_gel == '' AND $type_zn == '' AND $kanban_no == ''){
					...
					$upd_sts = "update ztb_assy_anode_gel_sts set flag = 1
						where rowid= (select b.rowid as row_sts from ztb_assy_anode_gel a 
	              					  ...
	              					  where b.flag = 0 and b.pemakaian_assy = 0 and id = $proses_no)";
