    ...
    <body>
			...
			<div align="center">
				...
				<fieldset style="float:left;width:47%;height: 330px;border-radius:4px;"><legend><span class="style3"><strong>VIEW</strong></span></legend>
					...
					<div class="fitem">
						...
						<input type="number" style="width:330px;text-align:right;" name="txt_density" id="txt_density" step="0.01" min="0" value="0"/>
					</div>
		...
		<script type="text/javascript">
			...
			function scan_kanban(event){
		        ...
		        if(event.keyCode == 13 || event.which == 13){
		        	...
		        	$.ajax({
						type: 'GET',
						url: 'cek_scan_tag.php?type_gel='+split[0]+'&type_zn='+split[1]+'&kanban_no='+split[2],
						data: { kode:'kode' },
		    ...
		    function proses(){
		    	...
		    	if(split1[0] != split2[0]){
		    		...
		    		document.getElementById('txt_no_tag').value = split2[2];
		...
		<?php
			if(isset($_POST['submit'])){
				...
				$upd2 = "update ztb_assy_anode_gel_sts set no_tag= $no_tag
