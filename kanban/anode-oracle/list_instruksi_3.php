...
<body>
	<span style="font-size: 10px;" align="left" >LIST OUTPUT DRY MIX </span>
...
<table class="w3-striped" align="center" style="width:850px;margin-top: 10px;">
	...
	<?php
		$table_list = "select kanban_no, type_gel, type_zn, to_char(upto_date_instruksi,'DD-MON-YYYY')||chr(13)||to_char(upto_date_instruksi,'HH24:MI:SS') as upto_date_ins,
			to_char(upto_date_drymix,'DD-MON-YYYY')||chr(13)||to_char(upto_date_drymix,'HH24:MI:SS') as upto_date_dry, no_adukan
