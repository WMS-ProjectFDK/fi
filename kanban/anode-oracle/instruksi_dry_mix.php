    ...
    <body>
				...
				<div align="left" style="width:100%;">
					...
					<fieldset style="position:absolute;margin-left:48.5%;border-radius:4px;width: 48.5%; height: 290px;"><legend><span class="style3"><strong>COMPOSITION</strong></span></legend>
						...
						<div class="fitem">
		    				...
		    				<textarea name="ket" id="ket" cols="58" rows="3" readonly=""></textarea>
		    			</div>
					</fieldset>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			function klik_tmbng_hv505_hc(){
				...
				//document.getElementById('tmbng_hv501_e').disabled = false;
			}
			...
			function klik_tmbng_hv501_e(){
				...
				//document.getElementById('tmbng_th_1758').disabled = false;
			}
