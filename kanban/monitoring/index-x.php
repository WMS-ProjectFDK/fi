...
<body>
		...
		<div class="fitem" align="center">
			<span style="display:inline-block;font-size: 30px;font-weight: bold;">Realtime Monitoring Stop Time Assembly Line (LR03#2)</span> 
		</div>
		 ...
		 <div id="toolbar" align="left">
			<fieldset style="width:auto;height: 280px;border-radius:3px;">
				...
				<div align="left">
					<span  style="width:230px;display:inline-block;font-size: 20px;font-weight: bold;">Process name :</span>
					<input type="text" style="width:145px;height: 40px;font-size: 20px;text-align: center;background-color: rgb(0,150,255);" name="tanggal" id="tanggal" value="Mould Ring"> </input>
					<input type="text" style="width:145px;height: 40px;font-size: 20px;text-align: center;background-color: rgb(0,150,255);" name="tanggal" id="tanggal" value="Can Supply"> </input>
					<input type="text" style="width:145px;height: 40px;font-size: 20px;text-align: center;background-color: rgb(0,150,255);" name="tanggal" id="tanggal" value="Mix Insert"> </input>
					<input type="text" style="width:145px;height: 40px;font-size: 20px;text-align: center;background-color: rgb(0,150,255);" name="tanggal" id="tanggal" value="Beading"> </input>
					<input type="text" style="width:145px;height: 40px;font-size: 20px;text-align: center;background-color: rgb(0,150,255);" name="tanggal" id="tanggal" value="Adhesive"> </input>
					<input type="text" style="width:145px;height: 40px;font-size: 20px;text-align: center;background-color: rgb(0,150,255);" name="tanggal" id="tanggal" value="Separator Insert"> </input>

				</div>	
				<div align="left">
					<span  style="width:230px;display:inline-block;font-size: 20px;font-weight: bold;">Stop Time :</span>
				
					<input type="text" style="width:145px;height: 40px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" name="tanggal" id="MOULD"> </input>
					<input type="text" style="width:145px;height: 40px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" name="tanggal" id="CANSUPPLY"> </input>
					<input type="text" style="width:145px;height: 40px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" name="tanggal" id="MIXINSERT"> </input>
					<input type="text" style="width:145px;height: 40px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" name="tanggal" id="BEADING"> </input>
					<input type="text" style="width:145px;height: 40px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" name="tanggal" id="ADHESIVE"> </input>
					<input type="text" style="width:145px;height: 40px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" name="tanggal" id="SEPARATORINSERT"> </input>
				</div>	
				...
				<div align="left">
						<span  style="width:230px;display:inline-block;font-size: 20px;font-weight: bold;">Process name :</span>
					<input type="text" style="width:145px;height: 40px;font-size: 19px;text-align: center;background-color: rgb(0,150,255);" name="tanggal" id="tanggal" value="Electrolyte Filling"> </input>
					<input type="text" style="width:145px;height: 40px;font-size: 20px;text-align: center;background-color: rgb(0,150,255);" name="tanggal" id="tanggal" value="Jig Stock"> </input>
					<input type="text" style="width:145px;height: 40px;font-size: 20px;text-align: center;background-color: rgb(0,150,255);" name="tanggal" id="tanggal" value="Anode Gel"> </input>
					<input type="text" style="width:145px;height: 40px;font-size: 20px;text-align: center;background-color: rgb(0,150,255);" name="tanggal" id="tanggal" value="Weight Checker"> </input>
					<input type="text" style="width:145px;height: 40px;font-size: 20px;text-align: center;background-color: rgb(0,150,255);" name="tanggal" id="tanggal" value="Curling Draw"> </input>
					<input type="text" style="width:145px;height: 40px;font-size: 20px;text-align: center;background-color: rgb(0,150,255);" name="tanggal" id="tanggal" value="Casing Loader"> </input>
				</div>	
				<div align="left">
						<span  style="width:230px;display:inline-block;font-size: 20px;font-weight: bold;">Stop Time :</span>
				
					<input type="text" style="width:145px;height: 40px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" name="tanggal" id="ELECFILLING"> </input>
					<input type="text" style="width:145px;height: 40px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" name="tanggal" id="JIGSTOCK"> </input>
					<input type="text" style="width:145px;height: 40px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" name="tanggal" id="ANODEGEL"> </input>
					<input type="text" style="width:145px;height: 40px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" name="tanggal" id="WCHECKER"> </input>
					<input type="text" style="width:145px;height: 40px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" name="tanggal" id="CURLINGDRAW"> </input>
					<input type="text" style="width:145px;height: 40px;background-color: rgb(0,255,0);font-size: 20px;text-align: center;" name="tanggal" id="CASINGLOADER"> </input>
				</div>	
			</fieldset>
				...
				// alert(data[0].STOPS);
	    		 ...
	    		 vrasio = data[0].RASIO;
				  ...
				  if (data[0].mouldingstat == false){
				  	...
				  	document.getElementById("CASINGLOADER").value = fancyTimeFormat(data[0].CASINGLOADER)
				  	j=0
				  	}else {
				  	...
				  	if (data[0].weighcheckstat == false){
				  	document.getElementById("WCHECKER").style.backgroundColor = "green"
					document.getElementById("WCHECKER").style.color = "black"
				  	document.getElementById("WCHECKER").value = fancyTimeFormat(data[0].WCHECKER)
				  	l=0
				  	}else {
				  		 document.getElementById("WCHECKER").style.backgroundColor = "red"
				  		 document.getElementById("WCHECKER").style.color = "white"
				  		 document.getElementById("WCHECKER").value = fancyTimeFormat(data[0].WCHECKER)
				  		 totalstop ++;;
				  	};	
...
data: [{
	...
	indexLabel: "{y}",
	dataPoints: [
		{ label: "MOULD", y: parseInt(data[0].MOULD2) },
		{ label: "CAN SUPPLY", y: parseInt(data[0].CANSUPPLY2) },
