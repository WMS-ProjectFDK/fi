...
<table class="w3-striped" align="center" style="width:650px;margin-top: 10px;">
	...
	<?php
		$table_list = "select cast(kanban_no as int) kanban_no, type_gel, type_zn, cast(no_adukan as int) no_adukan,
			CONVERT(VARCHAR(19), upto_date_instruksi,121) as upto_date
