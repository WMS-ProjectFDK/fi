    ...
    <body>
			  ...
			  <div align="center">
				<fieldset style="width:650px;height: auto;border-radius:4px;">
					...
					<div class="fitem">
						...
						<input style="width:50px;" name="txt_flag" id="txt_flag" hidden=""/>
					</div>
					<div class="fitem">
		...
		<?php
			if(isset($_POST['submit'])){
				...
				$cek = "select count(*) as j from ztb_assy_anode_gel_sts where flag=0 and pemakaian_assy=0 ";
				...
				if($row_cek[0] < 2){
					if($flag == 'NO'){
						...
						$field2 .= "PEMAKAIAN_ASSY,"		;	$value2 .= "0,"															;
						...
						$upd = "update ztb_assy_anode_gel_sts set pemakaian_assy = 0, type_zn = '$type_zn',
							UPTO_DATE = to_date('".date('Y-m-d H:i:s')."','yyyy-mm-dd hh24:mi:ss')
							where type_gel='$type_gel' AND kanban_no = $kanban_no ";
					...
					$field .= "UPTO_DATE_INSTRUKSI"	;	$value .= "to_date('".date('Y-m-d H:i:s')."','yyyy-mm-dd hh24:mi:ss')"	;
