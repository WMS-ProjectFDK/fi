...
if($varConn == 'Y'){
	if (isset($_SESSION['id_wms'])) {	
	    ...
	    $sql .= " data_date,"            ; $value .= "getdate()," ;
	    $sql .= " duein_date,"           ; $value .= "getdate()," ;
	    $sql .= " answer_no,"            ; $value .= "'$ans_no'," ;
	    $sql .= " curr_code,"            ; $value .= "'$CURR_CODE'," ;
	    $sql .= " u_price,"              ; $value .= "'$U_PRICE'," ;
	    $sql .= " operation_date,"       ; $value .= "getdate()," ;
		...
		$field .= "EX_FACT,"    ; $value_po .= "'$EX_FAC_DATE',"						;
		$field .= "ETD,"   	 	; $value_po .= "'$ETD_DATE',"							;
		$field .= "ETA,"        ; $value_po .= "'$ETA_DATE',"							;
		...
		// INSERT GRPANS_OUT
       	...
       	$qry_f .= "operation_date," 	;	$qry_v .= "getdate()," 							; 
