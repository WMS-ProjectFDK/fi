...
$qry = "select a.line_no, a.item_no, b.item, b.description, convert(varchar, a.eta, 23) as eta, a.qty, a.uom_q, c.unit_pl, c.unit, a.u_price, 
	po.curr_code,e.curr_short,e.curr_mark, a.amt_l, a.amt_o, a.MPR_NO
