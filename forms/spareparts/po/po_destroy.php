...
$cek = "select sum(gr_qty) as GR from sp_po_details where po_no='".$po_no."'";
...
if($Total == 0) {
	...
	$del = "delete from sp_po_header where po_no='".$po_no."'";
	$data_del = sqlsrv_query($connect, $del);
	

	if($data_del){
		// $cek = "select item_no, qty, prf_no, prf_line_no from sp_po_details where po_no='".$po_no."'";
		...
		$del2 = "delete from sp_po_details where po_no='".$po_no."'";
