...
<!DOCTYPE html>
		...
		<div id="toolbar" style="padding:10px 10px;height:140px">
			<fieldset style="float:left;width:1350px;height:125px;border-radius:4px;"><legend><span class="style3"><strong>Item Filter For Buying Price</strong></span></legend>
				...
				<div class="fitem">
					...
					<select style="width:330px;" name="cmb_item" id="cmb_item" class="easyui-combobox" data-options=" url:'../../json/json_sp_item_all.php', method:'get', valueField:'id_item', textField:'id_name_item', panelHeight:'150px',
			  ...
			  <div class="fitem">
				...
				<select style="width:330px;" name="cmb_supplier" id="cmb_supplier" class="easyui-combobox" data-options=" url:'../../json/json_sp_company.php',method:'get',valueField:'company_code',textField:'company', panelHeight:'150px',
				onSelect: function(rec){
	...
	<div id='dlg_add' class="easyui-dialog" style="width:500px;height:250px;padding:5px 5px;" closed="true" buttons="#dlg-buttons-add" data-options="modal:true">
	   <form id="ff" method="post" novalidate>	
		<div class="fitem">
				<span style="width:110px;display:inline-block;">Item No.</span>
					<select style="width:330px;" name="cmb_item_add" id="cmb_item_add" class="easyui-combobox" data-options=" url:'../../json/json_sp_item_all.php', method:'get', valueField:'id_item', textField:'id_name_item', panelHeight:'150px',
					onSelect:function(rec){
						//alert(rec.id_name_item);
						var spl = rec.id_name_item;
						var sp = spl.split(' - ');
		...
		<div class="fitem">
				<span style="width:110px;display:inline-block;">Supplier</span>
				<select style="width:330px;" name="cmb_supplier_add" id="cmb_supplier_add" class="easyui-combobox" data-options=" url:'../../json/sp_json_company.php',method:'get',valueField:'company_code',textField:'company', panelHeight:'150px',
				onSelect: function(rec){
					//alert(rec.company_code);
					$.ajax({
						type: 'GET',
						url: '../../json/json_sp_company_details.php?id='+rec.company_code,
						data: { kode:'kode' },
	...
	<div id='dlg_edit' class="easyui-dialog" style="width:500px;height:250px;padding:5px 5px;" closed="true" buttons="#dlg-buttons-edit" data-options="modal:true">
	   <form id="fx" method="post" novalidate>	
		<div class="fitem">
				<span style="width:110px;display:inline-block;">Item No.</span>
					<select style="width:330px;" name="cmb_item_edit" id="cmb_item_edit" class="easyui-combobox" data-options=" url:'../../json/json_sp_item_all.php', method:'get', valueField:'id_item', textField:'id_name_item', panelHeight:'150px',
					onSelect:function(rec){
						//alert(rec.id_name_item);
						var spl = rec.id_name_item;
						var sp = spl.split(' - ');
		...
		<div class="fitem">
				<span style="width:110px;display:inline-block;">Supplier</span>
				<select style="width:330px;" name="cmb_supplier_edit" id="cmb_supplier_edit" class="easyui-combobox" data-options=" url:'../../json/json_sp_company.php',method:'get',valueField:'company_code',textField:'company', panelHeight:'150px',
				onSelect: function(rec){
					//alert(rec.company_code);
					$.ajax({
						type: 'GET',
