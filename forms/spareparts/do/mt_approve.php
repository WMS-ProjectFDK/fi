...
<table id="dg" title="MATERIALS APPROVE SPAREPARTS" class="easyui-datagrid" toolbar="#toolbar" style="width:100%;height:490px;" rownumbers="true" fitColumns="true"></table>
...
<script type="text/javascript">
	...
	function filterData(){
		...
		$('#dg').datagrid( {
			...
			columns:[[
                ...
                {field:'COST_PROCESS_NAME',title:'ISSUE TO', halign:'center', width:200, sortable: true},
				{field:'CP_SECTION_NAME',title:'DEPT', halign:'center', width:150, sortable: true},
	...
	function save_approve(){
		...
		if(rows.length > 10){
			...
			console.log('mt_approve_save.php?approve_slip='+ArrApprove);
