<?php
	...
	$rs = "select a.slip_no, a.line_no, a.item_no, b.item, b.description, a.qty, a.uom_q, c.unit, a.cost_process_code as COST_SUBJECT_CODE, 
		a.reg_date, cast(a.upto_date as varchar(10)) upto_date, a.wo_no, a.date_code, a.remark, d.this_inventory, sum(a.qty) as sumqty
		...
		group by a.slip_no, a.line_no, a.item_no, b.item, b.description, a.qty, a.uom_q, c.unit, a.cost_process_code, 
