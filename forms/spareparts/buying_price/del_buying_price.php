<?php
	...
	$sql = "update sp_itemmaker set alter_procedure = alter_procedure - 1 where item_no = '$item_no'  and alter_procedure > $rank";
    $sql2 = "delete from sp_itemmaker where item_no = '$item_no' and supplier_code = '$supplier_code'";
