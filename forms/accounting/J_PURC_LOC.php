...
while ($s < 3) {
    if ($Arr_sheet[$s] == "INVOICES"){
        ...
        $objPHPExcel->getActiveSheet()->setTitle('Invoices_Details');
...
header('Content-Disposition: attachment; filename="JURNAL-PURCHASE-LOCAL-'.$period.'.xlsx"');
