...
<SCRIPT LANGUAGE=javascript>
	function checkInput(theForm){
		...
		if (!isNumber(theForm.labeling_to_pack_day.value )) { theForm.labeling_to_pack_day.value = 0  ;}   // add 2015/10/28
		if (!isNumber(theForm.assembling_to_lab_day.value )){ theForm.assembling_to_lab_day.value = 0  ;}  // add 2015/10/28
		...
		if (!isNumber(theForm.labeling_to_pack_day.value )) { alert("Data input into 'LABELING TO PACKAGING DAY' is not right.");	    return false; } // add 2015/10/28
		if (!isNumber(theForm.assembling_to_lab_day.value )){ alert("Data input into 'ASSEMBLING TO LABELING DAY' is not right.");  return false; } // add 2015/10/28
...
print " <TR>" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center'>LABELING TO PACKAGING DAY</TD>\n" ;
print "   <TD><INPUT TYPE=Text NAME=labeling_to_pack_day VALUE=\"$labeling_to_pack_day\" SIZE=4 MAXLENGTH=3 onChange='chkNum(this.form,this.value,\"3,0\")'>Days</TD>\n" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center'>ASSEMBLING TO LABELING DAY</TD>\n" ;
print "   <TD COLSPAN=3><INPUT TYPE=Text NAME=assembling_to_lab_day VALUE=\"$assembling_to_lab_day\" SIZE=4 MAXLENGTH=3 onChange='chkNum(this.form,this.value,\"3,0\")'>Days</TD>\n" ;
print " </TR>" ;
#(add 2015/10/28 end)
print " <TR>" ;
...
#(add 2015/10/28 start)
print " <TR>" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center'>CUSTOMER ITEM CODE</TD>\n" ;
print "   <TD><INPUT TYPE=Text NAME=customer_item_no VALUE=\"$customer_item_no\" SIZE=30 MAXLENGTH=25> \n</TD>\n" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center'>CUSTOMER ITEM NAME</TD>\n" ;
print "   <TD COLSPAN=3><INPUT TYPE=Text NAME=customer_item_name VALUE=\"$customer_item_name\" SIZE=40 MAXLENGTH=50> \n</TD>\n" ;
print " </TR>" ;
#(add 2015/10/28 end)
print " <TR>" ;
