...
'************************************
' CTN_GROSS_WEIGHT <NUMBER(24,8)>
'************************************
Val = Request.Form("c_gross_weight")
Ttl = "Ctn Gross Weight"
...
'************************************
' PALLET_WEIGHT <NUMBER(24,8)>
'************************************
Val = Request.Form("p_weight")
Ttl = "Pallet Weight"
...
<Input Type="hidden" Name="c_gross_weight"       Value="<% =Request("c_gross_weight") %>">
...
<Input Type="hidden" Name="p_weight"             Value="<% =Request("p_weight")        %>">
...
<TR>
   <TD bgcolor="#00ff00"><FONT color='#0000ff'>Ctn Gross Weight</FONT></TD>
   <TD bgcolor="<%= SET_BGCOLOR( CTN_GROSS_WEIGHT_FLG ) %>" align="right" colspan="5">
      <%= Request("c_gross_weight") %>&nbsp;KG
   </TD>
</TR>
<TR>
...
<TR>
   ...
   <TD bgcolor="<%= COLOR_PI %>">Step Ctn Number</TD>
</TR>
<TR>
...
<TR>
   <TD bgcolor="<%= COLOR_PI %>"><FONT color='#0000ff'>Pallet Weight</FONT></TD>
   <TD bgcolor="<%= SET_BGCOLOR( PALLET_WEIGHT_FLG ) %>" align="right" colspan=5>
      <%= Request("p_weight") %>&nbsp;KG
   </TD>
</TR>
