...
if($TYPES ne "DELETE"){
		...
		#(add 2015/10/28 start)
		if($labeling_to_pack_day   =~ /[^0-9 .]/){ $ERROR .=" 'LABELING TO PACKAGING DAY' is not right.<BR>";   $BG_LPD  ="lightpink" ; $ERR_MSG = "ERR"; }
		if($assembling_to_lab_day  =~ /[^0-9 .]/){ $ERROR .=" 'ASSEMBLING TO LABELING DAY' is not right.<BR>";	$BG_ATL  ="lightpink" ; $ERR_MSG = "ERR"; }
		#(add 2015/10/28 end)
...
#(add 2015/10/28 start)
print " <TR>" ;
print "   <TD BGCOLOR=LightGreen ALIGN=Right>LABELING TO PACKAGING DAY</TD>\n" ;
print "   <TD ALIGN=Right BGCOLOR=$BG_LPD>$labeling_to_pack_day Days</TD>\n" ;
print "   <TD BGCOLOR=LightGreen ALIGN=Right>ASSEMBLING TO LABELING DAY</TD>\n" ;
print "   <TD ALIGN=Right BGCOLOR=$BG_ATL>$assembling_to_lab_day Days</TD>\n" ;
...
#(add 2015/10/28 start)
print " <TR>" ;
print "   <TD BGCOLOR=LightGreen ALIGN=Right>CUSTOMER ITEM CODE</TD>\n" ;
print "   <TD >$customer_item_no<BR></TD>\n" ;
print "   <TD BGCOLOR=LightGreen ALIGN=Right>CUSTOMER ITEM NAME</TD>\n" ;
print "   <TD COLSPAN=3 >$customer_item_name<BR></TD>\n" ;
print " </TR>" ;
#(add 2015/10/28 end)
print " <TR>" ;
...
print " </TR>" ;
print " <TR>" ;
print "   <TD BGCOLOR=LightGreen ALIGN=Right><FONT COLOR=RED>PACKAGING GROUPING</FONT></TD>\n" ;
...
print " </TR>" ;
print " <TR>" ;
print "   <TD BGCOLOR='$COLOR_PI' ALIGN=Right><FONT COLOR=RED>PACKING<BR>INFORMATION NO</FONT></TD>\n" ;
print "   <TD BGCOLOR=$BG_PI_NO>&nbsp;$pi_no</TD>\n" ;
print "   <TD BGCOLOR='$COLOR_PI' ALIGN=Right><FONT COLOR=RED>PLT SPEC NO</FONT></TD>\n" ;
print "   <TD BGCOLOR=$BG_PLT_SPEC_NO>&nbsp;$plt_spec_no</TD>\n" ;
print "   <TD BGCOLOR='$COLOR_PI' ALIGN=Right><FONT COLOR=RED>PALLET SIZE TYPE</FONT></TD>\n" ;
print "   <TD BGCOLOR=$BG_PALLET_SIZE_TYPE>&nbsp;$PALLET_SIZE_TYPE[$pallet_size_type]</TD>\n" ;
print " </TR>" ;
print " <TR>" ;
print "   <TD BGCOLOR='$COLOR_PI' ALIGN=Right ROWSPAN=4>PALLET</TD>\n" ;
