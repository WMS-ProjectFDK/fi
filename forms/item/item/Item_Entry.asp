...
'-- 2015/07/03 Y.Hagai    Label Type名称変更⇒Packaging Grouping に変更
'-- 2015/10/28 NTTk)Hino  項目追加（Labeling To Packaging Day他 計4項目）
'-- 2016/03/17 mazda      項目追加（CTN_GROSS_WEIGHT,PALLET_WEIGHT）
...
Else
	...
	'(add 2015/07/03 start)
	If STOCK_SUB = "" Then
		STOCK_SUB = Request.QueryString("stock_subject_code") 'S/O Entry (GROUP ORDER)の「NEW ITEM ENTRY」から呼ばれた場合
	End If
	'(add 2015/07/03 end)
...
P_TYPE = Request("type") 'add 2015/07/03
 ...
 If FLG = "1" Then
	 ...
	 '-------------------------------------
	  SQL =  "select PI_NO, PLT_SPEC_NO, PALLET_UNIT_NUMBER, PALLET_CTN_NUMBER, " & _
		     ...
		     "       PALLET_SIZE_TYPE, PALLET_WEIGHT " & _
...
Function GET_VAL_CMN(p_DB_ID, p_FORM_ID, isPI)
	...
	Else
		...
		If P_TYPE = "NEW" Then '(mod 2015/07/03)
			GET_VAL_CMN = ""
		'ElseIf Request.Form("type") = "CHANGE" And Request.Form("delete_type") <> "D" Then
		ElseIf P_TYPE = "CHANGE" And Request.Form("delete_type") <> "D" Then '(mod 2015/07/03)
...
function go_back(){
	...
	var type = "<%= P_TYPE %>"; //(mod 2015/07/03)
	if ( type == "NEW" ) {
...
<% IF REQUEST("type") = "NEW" AND REQUEST("GRP_FLG") = " " THEN %>
 ...
 <Br>
 If text color is <Font Color="#0000ff">Blue</Font>, Input Number only.   If background color is Yellow, need input.
 <Tr>
 ...
 <% IF CStr(REQUEST("no_type")) = "GROUP" THEN %>
  ...
  <Input Type="text" Name="item_no" Size="8" Maxlength="8" value='<%= GET_VAL("ITEM_NO", "item_no") %>' style="background-color:<%= COLOR_NOT_NULL %>"><!-- mod 2015/04/21 -->
 ...
 <% ELSEIF CStr(REQUEST("no_type")) = "NGM" THEN %>
  ...
  <Input Type="text" Name="item_no" Size="8" Maxlength="8" value='<%= GET_VAL("ITEM_NO", "item_no") %>' style="background-color:<%= COLOR_NOT_NULL %>"> NG Materials ITEM NO is 9XXXXXXXX<!-- mod 2015/04/21 -->
 ...
 <Td ColSpan="2"><Input Type="text" Name="item" Size="40" Maxlength="40" value='<%= GET_VAL("ITEM", "item") %>' style="background-color:<%= COLOR_NOT_NULL %>"></Td><!-- mod 2015/04/21 -->
 ...
 <Td ColSpan="2"><Select Name="class_code" Size="1" style="background-color:<%= COLOR_NOT_NULL %>">
  <Option Value="">
 <%
 '------------------
 ' class get
 ...
 <Td ColSpan="2">
   <Select Name="unit_stock" Size="1" style="background-color:<%= COLOR_NOT_NULL %>">
     <Option Value="">
       <%
       '------------------
       ' unit stock get
 ...
 <Td ColSpan="2">
   <Select Name="unit_engineering" Size="1" style="background-color:<%= COLOR_NOT_NULL %>">
     <Option Value="">
     <%
     '------------------
     ' unit of quantity get
 ...
 <Input Type="text" Name="unit_stock_rate" Size="6" Maxlength="6" value='<%= GET_VAL("UNIT_STOCK_RATE", "unit_stock_rate") %>' style="background-color:<%= COLOR_NOT_NULL %>"><!-- mod 2015/04/21 -->
 :
 <!--<Input Type="text" Name="unit_engineer_rate" Size="6" Maxlength="6">-->
 <Input Type="text" Name="unit_engineer_rate" Size="6" Maxlength="6" value='<%= GET_VAL("UNIT_ENGINEER_RATE", "unit_engineer_rate") %>' style="background-color:<%= COLOR_NOT_NULL %>"><!-- mod 2015/04/21 -->
 </Td>
 </Tr>
 <Tr>
 ...
 <Td>
 <Select Name="uom_w" Size="1" style="background-color:<%= COLOR_NOT_NULL %>">
   <Option Value="">
   <%
   '------------------
   ' unit of weight get
 ...
 <Td>
   <Select Name="uom_l" Size="1" style="background-color:<%= COLOR_NOT_NULL %>">
     <Option Value="">
     <%
     '------------------
     ' unit of length get
 ...
 <Td ColSpan="2"><Input Type="text" Name="catalog_no" Size="28" Maxlength="28" value='<%= GET_VAL("CATALOG_NO", "catalog_no") %>'></Td>
   ...
   <% ELSE %>
     <Tr>
       ...
       <Td><Input Type="text" Name="standard_price" Size="24" Maxlength="24" value='<%= GET_VAL("STANDARD_PRICE", "standard_price") %>' style="background-color:<%= COLOR_NOT_NULL %>"></Td><!-- mod 2015/04/21 -->
 ...
 <Tr>
 <Td BgColor="#00ff00"><Font Color="#0000ff">Labeling To Packaging Day</Font></Td>
 <Td><Input Type="text" Name="lab_to_pack_day" Size="3" Maxlength="3" value='<%= GET_VAL("LABELING_TO_PACK_DAY", "lab_to_pack_day") %>'>Days</Td>
 <Td BgColor="#00ff00"><Font Color="#0000ff">Assembling To Labeling Day</Font></Td>
 <Td colspan="3"><Input Type="text" Name="assembling_to_lab_day" Size="3" Maxlength="3" value='<%= GET_VAL("ASSEMBLING_TO_LAB_DAY", "assembling_to_lab_day") %>'>Days</Td>
 </Tr>
 <!-- add 2015/10/28 end -->
 ...
 <Td ColSpan="2">
   <Select Name="section_code" Size="1" style="background-color:<%= COLOR_NOT_NULL %>">
     <Option Value="">
     <%
     '------------------
     ' section code get
...
%>
 ...
 <Td ColSpan="2">
   <Select Name="cost_process_code" Size="1" style="background-color:<%= COLOR_NOT_NULL %>">
     <Option Value="">
     <%
     '------------------
 ...
 <Td ColSpan="2">
   <Select Name="cost_subject_code" Size="1" style="background-color:<%= COLOR_NOT_NULL %>">
     <Option Value="">
     <%
     '------------------
 ...
 <Td ColSpan="2">
   <Input Type="text" Name="cust_item_no" Value='<%= GET_VAL("CUSTOMER_ITEM_NO", "cust_item_no") %>' Size="30" Maxlength="25">
 </Td>
 <Td BgColor="#00ff00">Customer Item Name</Td>
 <Td ColSpan="2">
   <Input Type="text" Name="cust_item_name" Value='<%= GET_VAL("CUSTOMER_ITEM_NAME", "cust_item_name") %>' Size="40" Maxlength="50">
 </Td>
 </Tr>
 <!-- add 2015/10/28 end-->
...
<% IF REQUEST("type") = "NEW" AND REQUEST("GRP_FLG") <> " " THEN %>
 ...
 <Td BgColor="#00ff00">Class Code</Td>
 <Td ColSpan="2">
   <Select Name="class_code" Size="1" style="background-color:<%= COLOR_NOT_NULL %>">
     <Option Value="">
     <%
     '------------------
     ' class get
...
%>
<Input Type="text" Name="item" Value="<%= replace(CHANGE_ITEM_VAL &"","""","&quot;") %>" Size="40" Maxlength="40" style="background-color:<%= COLOR_NOT_NULL %>"><!-- mod 2015/04/21 -->
<!-- mod 2015/04/21 End -->
...
<Input Type="text" Name="unit_stock_rate" Value='<%= GET_VAL("UNIT_STOCK_RATE", "unit_stock_rate") %>' Size="6" Maxlength="6" style="background-color:<%= COLOR_NOT_NULL %>"><!-- mod 2015/04/21 -->
 :
<!--<Input Type="text" Name="unit_engineer_rate" Value="<%= REC_CHANGE.FIELDS("UNIT_ENGINEER_RATE") %>" Size="6" Maxlength="6">-->
<Input Type="text" Name="unit_engineer_rate" Value='<%= GET_VAL("UNIT_ENGINEER_RATE", "unit_engineer_rate") %>' Size="6" Maxlength="6" style="background-color:<%= COLOR_NOT_NULL %>"><!-- mod 2015/04/21 -->
</Td>
</Tr>
<Tr>
...
<% ELSE %>
 ...
 <Input Type="text" Name="standard_price" Value='<%= GET_VAL("STANDARD_PRICE", "standard_price") %>' Size="24" Maxlength="24" style="background-color:<%= COLOR_NOT_NULL %>"><!-- mod 2015/04/21 -->
 </Td>
 <Td BgColor="#00ff00"><Font Color="#0000ff">Next Term Price</Font></Td>
 <Td>
...
<Td BgColor="#00ff00"><Font Color="#0000ff">Labeling To Packaging Day</Font></Td>
<Td>
<Input Type="text" Name="lab_to_pack_day" Value='<%= GET_VAL("LABELING_TO_PACK_DAY", "lab_to_pack_day") %>' Size="3" Maxlength="3">
Days</Td>
<Td BgColor="#00ff00"><Font Color="#0000ff">Assembling To Labeling Day</Font></Td>
<Td colspan="3">
<Input Type="text" Name="assembling_to_lab_day" Value='<%= GET_VAL("ASSEMBLING_TO_LAB_DAY", "assembling_to_lab_day") %>' Size="3" Maxlength="3">
Days</Td>
</Tr>
<!-- add 2015/10/28 end -->
...
<% SQL_DELETE = "SELECT ITEM, ITEM_CODE, ITEM_FLAG, " & _
                ...
                "p.PALLET_STEP_CTN_NUMBER, p.PALLET_HEIGHT, p.PALLET_WIDTH, p.PALLET_DEPTH, p.PALLET_SIZE_TYPE, " & _
                "p.PALLET_WEIGHT, " & _
                "AGING_DAY, CTN_GROSS_WEIGHT, PACKAGE_UNIT_NUMBER, UNIT_PACKAGE, " & _
                "LABELING_TO_PACK_DAY, ASSEMBLING_TO_LAB_DAY, CUSTOMER_ITEM_NO, CUSTOMER_ITEM_NAME " & _
                "FROM  ITEM i, " & _
                "      PACKING_INFORMATION p " & _
                "WHERE ITEM_NO = " & CLng(REQUEST("ITEM_NO")) & _
...
<Input Type="hidden" Name="unit_stock_rate" Value="<%= REC_DEL.FIELDS("UNIT_STOCK_RATE") %>" Size="6" Maxlength="6" style="background-color:<%= COLOR_NOT_NULL %>">
:
<% RESPONSE.WRITE REC_DEL.FIELDS("UNIT_ENGINEER_RATE") %>
<Input Type="hidden" Name="unit_engineer_rate" Value="<%= REC_DEL.FIELDS("UNIT_ENGINEER_RATE") %>" Size="6" Maxlength="6" style="background-color:<%= COLOR_NOT_NULL %>">
</Td>
</Tr>
<Tr>
<Td BgColor="#00ff00">Weight</Td>
...
<Td>
<%= REC_DEL.FIELDS("LABELING_TO_PACK_DAY") %>
<Input Type="hidden" Name="lab_to_pack_day" Value="<%= REC_DEL.FIELDS("LABELING_TO_PACK_DAY") %>">
&nbsp;Days</Td>
<Td BgColor="#00ff00">Assembling To Labeling Day</Td>
<Td colspan="3">
<%= REC_DEL.FIELDS("ASSEMBLING_TO_LAB_DAY") %>
...
<% END IF %>
 ...
 <Tr>
 <Td BgColor="#00ff00">Customer Item Code</Td>
 <Td ColSpan="2"><% RESPONSE.WRITE REC_DEL.FIELDS("CUSTOMER_ITEM_NO") %></Td>
 <Td BgColor="#00ff00">Customer Item Name</Td>
 <Td ColSpan="2"><% RESPONSE.WRITE REC_DEL.FIELDS("CUSTOMER_ITEM_NAME") %></Td>
 </Td>
 </Tr>
 <!-- add 2015/10/28 end-->
...
<%
  If Session("FI_PACKAGE_UNIT") = "1" Then
    ...
    If P_TYPE = "DELETE" Or _
       (P_TYPE = "CHANGE" And Request.Form("delete_type") = "D") Then  '(mod 2015/07/03)
    %>
	    <TR>
    ...
    Else
	    ...
	    <TR>
	       <TD BgColor="#00ff00">Package Unit Number</Td>
	       <TD ColSpan="2">
		       <INPUT TYPE=TEXT   NAME=package_unit_number VALUE="<%= wk_package_unit_number %>" Size=12 MaxLength=8 style="background-color:<%= COLOR_NOT_NULL %>">
		       <SELECT NAME=unit_package style="background-color:<%= COLOR_NOT_NULL %>">
		           <OPTION VALUE="">
		           <%  
...
'	Response.Write "<Input Type='hidden' Name='PACKAGE_TYPE'  Value='" & wk_PACKAGE_TYPE & "'>" & VbCrLf
   ...
   '-- 2015/04/21 NTTk)Hino Start --
	...
	Response.Write "<TR>" & VbCrLf
		...
		Else
			Response.Write "<TD><INPUT type='text' name='capacity' size='18' maxlength='25' value='" & GET_VAL("CAPACITY", "capacity") & "' style='background-color:" & COLOR_NOT_NULL & "'></TD>" & VbCrLf
		End If
	...
	Response.Write "<TR>" & VbCrLf
		Response.Write "<TD bgcolor='#00ff00'><FONT>Packaging Grouping</FONT></TD>" & VbCrLf
		Response.Write "<TD>" & VbCrLf
			If IS_VIEW Then
				...
				End If
			Else
				Response.Write "<SELECT name='label_type' style='background-color:"& COLOR_NOT_NULL &"'>" & VbCrLf
				Response.Write "<OPTION value=''>" & VbCrLf
	...
	'入力欄（CTN_GROSS_WEIGHT）
	Response.Write "<TR>" & VbCrLf
		Response.Write "<TD bgcolor='#00ff00'><FONT color='#0000ff'>Ctn Gross Weight</FONT></TD>" & VbCrLf
		If IS_VIEW Then
			Response.Write "<TD colspan='5' style='text-align:right'><FONT>" & GET_VAL("CTN_GROSS_WEIGHT", "c_gross_weight") & "&nbsp;KG</FONT></TD>" & VbCrLf
		Else
			Response.Write "<TD colspan='5'><FONT><INPUT type='text' name='c_gross_weight' size='18' maxlength='25' value='" & GET_VAL("CTN_GROSS_WEIGHT", "c_gross_weight") & "' style='text-align:right;'>&nbsp;KG</FONT></TD>" & VbCrLf
		End If
	Response.Write "</TR>" & VbCrLf
	...
	Response.Write "<TR>" & VbCrLf
		Response.Write "<TD bgcolor='" & COLOR_PI & "' nowrap><FONT>Packing Information No.</FONT></TD>" & VbCrLf
		If IS_VIEW Then
			Response.Write "<TD style='text-align:right'>&nbsp;" & GET_VAL_CMN("PI_NO", "packing_information", "PI") & "</TD>" & VbCrLf
		Else
			Response.Write "<TD><INPUT type='text' name='packing_information' size='22' maxlength='20' value='" & GET_VAL_CMN("PI_NO", "packing_information", "PI") & "' onChange='get_pack_info()' style='background-color:" & COLOR_NOT_NULL & "'></TD>" & VbCrLf
		End If
		
		Response.Write "<TD bgcolor='" & COLOR_PI & "'><FONT>PLT Spec No.</FONT></TD>" & VbCrLf
		If IS_VIEW Then
			Response.Write "<TD style='text-align:right'>&nbsp;" & GET_VAL_CMN("PLT_SPEC_NO", "plt_spec_no", "PI") & "</TD>" & VbCrLf
		Else
			Response.Write "<TD><INPUT type='text' name='plt_spec_no' size='22' maxlength='20' value='" & GET_VAL_CMN("PLT_SPEC_NO", "plt_spec_no", "PI") & "' style='background-color:" & COLOR_NOT_NULL & "'></TD>" & VbCrLf
		End If
		
		Response.Write "<TD bgcolor='" & COLOR_PI & "'><FONT color='#0000ff'>Pallet Size Type</FONT></TD>" & VbCrLf
		Response.Write "<TD>" & VbCrLf
			...
			Else
				Response.Write "<SELECT name='pallet_size_type' style='background-color:" & COLOR_NOT_NULL & "'>" & VbCrLf
				Response.Write "<OPTION value=''>" & VbCrLf
	...
	'タイトル（高さ、巾、奥行、梱包数）
	Response.Write "<TR>" & VbCrLf
		Response.Write "<TD bgcolor='" & COLOR_PI & "' rowspan='4'>Pallet</TD>" & VbCrLf
		Response.Write "<TD bgcolor='" & COLOR_PI & "' align='center'><FONT color='#0000ff'>Height</FONT></TD>" & VbCrLf
		Response.Write "<TD bgcolor='" & COLOR_PI & "' align='center'><FONT color='#0000ff'>Width</FONT></TD>" & VbCrLf
		Response.Write "<TD bgcolor='" & COLOR_PI & "' align='center'><FONT color='#0000ff'>Depth</FONT></TD>" & VbCrLf
		Response.Write "<TD bgcolor='" & COLOR_PI & "' align='center' colspan='2'><FONT color='#0000ff'>Unit Number</FONT></TD>" & VbCrLf
	Response.Write "</TR>" & VbCrLf
	...
	Response.Write "</TR>" & VbCrLf
	Response.Write "<TR>" & VbCrLf
		Response.Write "<TD bgcolor='" & COLOR_PI & "' align='center'><FONT color='#0000ff'>Ctn Number</FONT></TD>" & VbCrLf
		Response.Write "<TD bgcolor='" & COLOR_PI & "' align='center'><FONT color='#0000ff'>Step Ctn Number</FONT></TD>" & VbCrLf
	Response.Write "</TR>" & VbCrLf
	Response.Write "<TR>" & VbCrLf
		If IS_VIEW Then
	...
	'入力欄（PALLET WEIGHT）
	Response.Write "<TR>" & VbCrLf
		Response.Write "<TD bgcolor='" & COLOR_PI & "' nowrap><FONT color='#0000ff'>Pallet Weight</FONT></TD>" & VbCrLf
		If IS_VIEW Then
			Response.Write "<TD colspan='5' style='text-align:right'><FONT>" & GET_VAL_CMN("PALLET_WEIGHT", "p_weight", "PI") & "&nbsp;KG</FONT></TD>" & VbCrLf
		Else
			Response.Write "<TD colspan='5'><FONT><INPUT type='text' name='p_weight'  size='18' maxlength='25' value='" & GET_VAL_CMN("PALLET_WEIGHT", "p_weight", "PI") & "' style='text-align:right;'>&nbsp;KG</FONT></TD>" & VbCrLf
		End If
	Response.Write "</TR>" & VbCrLf
	...
	Response.Write "<TR>" & VbCrLf
		...
		Else
			Response.Write "<TD><INPUT type='text' name='operation_time' size='18' maxlength='25' value='" & GET_VAL("OPERATION_TIME", "operation_time") & "' style='background-color:" & COLOR_NOT_NULL & "'></TD>" & VbCrLf
		End If
		...
		Else
			Response.Write "<TD><INPUT type='text' name='aging_day' size='5' maxlength='3' value='" & GET_VAL("AGING_DAY", "aging_day") & "' style='background-color:" & COLOR_NOT_NULL & "'></TD>" & VbCrLf
		End If
	Response.Write "</TR>" & VbCrLf
   '-- 2015/04/21 NTTk)Hino End --
