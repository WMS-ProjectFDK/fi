...
#	$sql .= "last_term_price     = '$last_term_price'     ," ; #前期の値は画面上からは変更不可！
	...
	# add 2015/04/21 End
	# add 2015/10/28 Start
	$sql .= "labeling_to_pack_day   = '$labeling_to_pack_day'    ," ;
	$sql .= "assembling_to_lab_day  = '$assembling_to_lab_day'   ," ;
	$sql .= "customer_item_no       = '$customer_item_no'        ," ;
	$sql .= "customer_item_name     = '$customer_item_name'      ," ;
	# add 2015/10/28 End
	chop($sql) ;
