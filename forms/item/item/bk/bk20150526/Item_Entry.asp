...
<% IF REQUEST("type") = "NEW" AND REQUEST("GRP_FLG") = " " THEN %>
 ...
 <Td ColSpan="2"><Input Type="text" Name="drawing_no" Size="30" Maxlength="20"></Td>
...
<Td BgColor="#00ff00">DRAWING NO</Td>
<Td ColSpan="2">
<Input Type="text" Name="drawing_no" Value="<%= Replace(REC_CHANGE.FIELDS("DRAWING_NO") &"","""","&quot;") %>" Size="30" Maxlength="20">
</Td>
<Td BgColor="#00ff00">DRAWING REV</Td>
<Td ColSpan="2">
...
<Input Type="hidden" Name="drawing_no" Value="<%= REC_DEL.FIELDS("DRAWING_NO") %>" Size="30" Maxlength="20">
&nbsp;</Td>
<Td BgColor="#00ff00">DRAWING REV</Td>
<Td ColSpan="2">
