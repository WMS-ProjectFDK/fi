...
<Div Align="left"><H3>Select Item that You Want  Delete.</H3></Div><Br>
<Div Align="center">
...
<!-- DATA GET START -->
<Div Align="center">
<Form Method="post" Action="delete_item_main.asp?KEYWORD=<%=KEYWORD%>" Name="myform">
...
<Form Method="post" Action="delete_Item_Entry.asp?KEYWORD=<%=KEYWORD%>" Name="<%= "delete" %>" Target="_self">
