...
#
     ...
     $sql .="  to_char(i.standard_price, '999,999,999,990.000000') standard_price ," ;
     $sql .="  to_char(i.next_term_price,'999,999,999,990.000000') next_term_price ," ;
     $sql .="  to_char(i.suppliers_price,'999,999,990.000000')     suppliers_price," ;
