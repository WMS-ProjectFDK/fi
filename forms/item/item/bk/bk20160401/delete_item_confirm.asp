...
KEYWORD = Request("KEYWORD")
  ...
  call html_header("delete Item Entry Confirmation",KEYWORD)
%>
<%
'---------
'DB OPEN
...
<Div Align="center">
<Form Method="post" Action="delete_Item_Result.asp?KEYWORD=<%=KEYWORD%>" Name="data_send" Target="_self">
<% IF ERROR_MESSAGE = "" THEN %>
 <Input Type="submit" Name="entry_button" Value="CONFIRM">
<% END IF %>
...
<Tr>
 ...
 <Td><%= Request.form("labeling_to_pack_day") %>&nbsp;</Td>
 <Td BgColor="#00ff00">Assembling To Labeling Day</Td>
 <Td><%= Request.form("assembling_to_lab_day") %>&nbsp;</Td>
 <Td colspan="2">&nbsp;</Td>
</Tr>
<!-- add 2015/10/28 end -->
...
<Tr>
 ...
 <Td colspan="2"><%= Request.form("customer_item_no") %>&nbsp;</Td>
 <Td BgColor="#00ff00">Customer Item Name</Td>
 <Td colspan="2"><%= Request.form("customer_item_name") %>&nbsp;</Td>
</Tr>
<!-- add 2015/10/28 end -->
...
<TR>
   ...
   <TD ColSpan="2" BgColor="<% =Bg_PACKAGE_UNIT %>">
      <% =Request.Form("package_unit_number") %>&nbsp;
      <% =unit_package_disp              %>&nbsp;
   </TD>
...
<Tr>
  ...
  <Td>
    <%= Request.Form("date_code_type") %>&nbsp;
  </Td>
  <Td BgColor="#00ff00">Date Code Month</Td>
  <Td>
    <%= Request.Form("date_code_month") %>&nbsp;
  </Td>
</Tr>
<Tr>
  <Td BgColor="#00ff00">Label Type</Td>
  <Td>
    <%= Request.Form("label_type_name") %>&nbsp;
  </Td>
...
<Tr>
  ...
  <Td Align="right">
    <%= Request.Form("i_height") %>&nbsp;mm
  </Td>
  <Td Align="right">
    <%= Request.Form("i_width") %>&nbsp;mm
  </Td>
  <Td Align="right">
    <%= Request.Form("i_depth") %>&nbsp;mm
  </Td>
  <Td Align="right" Colspan="2">
    <%= Request.Form("i_unit_number") %>&nbsp;PC
  </Td>
</Tr>
<Tr>
  <Td BgColor="#00ff00">Outer  Box</Td>
  <Td Align="right">
    <%= Request.Form("m_height") %>&nbsp;mm
  </Td>
  <Td Align="right">
    <%= Request.Form("m_width") %>&nbsp;mm
  </Td>
  <Td Align="right">
    <%= Request.Form("m_depth") %>&nbsp;mm
  </Td>
  <Td Align="right" Colspan="2">
    <%= Request.Form("m_unit_number") %>&nbsp;PC
  </Td>
</Tr>
<Tr>
  <Td BgColor="#00ff00">Medium Box</Td>
  <Td Align="right">
    <%= Request.Form("o_height") %>&nbsp;mm
  </Td>
  <Td Align="right">
    <%= Request.Form("o_width") %>&nbsp;mm
  </Td>
  <Td Align="right">
    <%= Request.Form("o_depth") %>&nbsp;mm
  </Td>
  <Td Align="right" Colspan="2">
    <%= Request.Form("external_unit_number") %>&nbsp;PC
  </Td>
</Tr>
<Tr>
  <Td BgColor="#00ff00">Packing Information No.</Td>
  <Td>
    <%= Request.Form("pi_no") %>&nbsp;
  </Td>
  <Td BgColor="#00ff00">PLT Spec No.</Td>
  <Td>
    <%= Request.Form("plt_spec_no") %>&nbsp;
  </Td>
  <Td BgColor="#00ff00">Pallet Size Type</Td>
  <Td>
    <%= Request.Form("pallet_size_type_name") %>&nbsp;
  </Td>
</Tr>
<Tr>
  <Td BgColor="#00ff00" Rowspan="4">Pallet</Td>
  <Td BgColor="#00ff00" Align="center">Height</Td>
  <Td BgColor="#00ff00" Align="center">Width</Td>
  <Td BgColor="#00ff00" Align="center">Depth</Td>
  <Td BgColor="#00ff00" Align="center" Colspan="2">Unit Number</Td>
...
<Tr>
  <Td Align="right" Rowspan="3">
    <%= Request.Form("p_height") %>&nbsp;mm
  </Td>
  <Td Align="right" Rowspan="3">
    <%= Request.Form("p_width") %>&nbsp;mm
  </Td>
  <Td Align="right" Rowspan="3">
    <%= Request.Form("p_depth") %>&nbsp;mm
  </Td>
  <Td Align="right" Colspan="2">
    <%= Request.Form("p_unit_number") %>&nbsp;PC
  </Td>
</Tr>
<Tr>
  <Td BgColor="#00ff00" Align="center">Ctn Number</Td>
  <Td BgColor="#00ff00" Align="center">Step Ctn Numbetr</Td>
</Tr>
<Tr>
  <Td Align="right">
    <%= Request.Form("p_ctn_number") %>&nbsp;
  </Td>
  <Td Align="right">
    <%= Request.Form("p_step_ctn_number") %>&nbsp;
  </Td>
</Tr>
<Tr>
  <Td BgColor="#00ff00">Operation Time</Td>
  <Td>
    <%= Request.Form("operation_time") %>&nbsp;
  </Td>
  <Td BgColor="#00ff00">Man Power</Td>
  <Td>
    <%= Request.Form("man_power") %>&nbsp;
  </Td>
  <Td BgColor="#00ff00">Aging Day</Td>
  <Td>
    <%= Request.Form("aging_day") %>&nbsp;
  </Td>
</Tr>
