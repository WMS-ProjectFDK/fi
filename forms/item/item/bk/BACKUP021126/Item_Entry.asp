...
<% ELSE
 DO While not Reccurrency.EOF %>
 <% IF CLng(REC_CHANGE.FIELDS("CURR_CODE")) = CLng(Reccurrency.Fields("CURR_CODE")) THEN %>
  <Option Value="<%= Reccurrency.Fields("CURR_CODE") %>" SELECTED><%= Reccurrency.Fields("CURR_MARK") %>
 <% ELSE %>
  <Option Value="<%= Reccurrency.Fields("CURR_CODE") %>"><%= Reccurrency.Fields("CURR_MARK") %>
 <% END IF %>
...
<% ELSE
 DO While not Rec_unit_stock.EOF %>
 <% IF CLng(REC_CHANGE.FIELDS("UNIT_STOCK")) = CLng(Rec_unit_stock.Fields("UNIT_CODE")) THEN %>
...
<% ELSE
 DO While not Rec_unit_eng.EOF %>
 <% IF CLng(REC_CHANGE.FIELDS("UNIT_ENGINEERING")) = CLng(Rec_unit_eng.Fields("UNIT_CODE")) THEN %>
...
<% ELSE
 DO While not Rec_uow.EOF %>
 <% IF CLng(REC_CHANGE.FIELDS("UOM_W")) = CLng(Rec_uow.Fields("UNIT_CODE")) THEN %>
...
<% ELSE
 DO While not Rec_uol.EOF %>
 <% IF CLng(REC_CHANGE.FIELDS("UOM_L")) = CLng(Rec_uol.Fields("UNIT_CODE")) THEN %>
...
<% ELSE
 DO While not Rec_section.EOF %>
 <% IF CLng(REC_CHANGE.FIELDS("SECTION_CODE")) = CLng(Rec_section.Fields("SECTION_CODE")) THEN %>
