...
print " </TR>" ;
 ...
 if ($CONF{'FI_PACKAGE_UNIT'} eq "1") {
     ...
     print "   <TD COLSPAN=5>\n" ;
     print "      <INPUT TYPE=Text NAME=package_unit_number VALUE=\"$package_unit_number\" SIZE=7 MAXLENGTH=6> \n" ;
     print "      <SELECT NAME=unit_package>\n" ;
     print "          <OPTION VALUE=\"\">\n" ;
                      for ($i=0 ; $i<$UNQ_NUM ; $i++){
                          undef $selected ;
...
print "   <TD><INPUT TYPE=Text NAME=capacity VALUE=\"$capacity\" SIZE=18 MAXLENGTH=25 onChange='chkNum(this.form,this.value,\"24,8\")'></TD>\n" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center'>DATE CODE TYPE</TD>\n" ;
print "   <TD><INPUT TYPE=Text NAME=date_code_type VALUE=\"$date_code_type\" SIZE=8 MAXLENGTH=10'></TD>\n" ;
...
print " </TR>" ;
print " <TR>" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center'><FONT COLOR=RED><B>LABEL TYPE</B></FONT></TD>\n" ;
print "   <TD>" ;
print "   <SELECT NAME=label_type>" ;
		  print "<OPTION VALUE=''>" ;
...
print " </TR>" ;
print " <TR>" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center'><FONT COLOR=RED><B>PACKING<BR>INFORMATION NO</B></FONT></TD>\n" ;
print "   <TD><INPUT TYPE=Text NAME=pi_no VALUE=\"$pi_no\" SIZE=18 MAXLENGTH=25 onChange=\"get_pack_info();\"></TD>\n" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center'><FONT COLOR=RED><B>PLT SPEC NO</B></FONT></TD>\n" ;
print "   <TD><INPUT TYPE=Text NAME=plt_spec_no VALUE=\"$plt_spec_no\" SIZE=22 MAXLENGTH=20 ></TD>\n" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center'><FONT COLOR=RED><B>PALLET SIZE TYPE</B></FONT></TD>\n" ;
print "   <TD>" ;
print "   <SELECT NAME=pallet_size_type>" ;
          print "<OPTION VALUE=''>" ;
...
print " </TR>" ;
print " <TR>" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center' ROWSPAN=4>PALLET</TD>\n" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center'>HEIGHT</TD>\n" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center'>WIDTH</TD>\n" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center'>DEPTH</TD>\n" ;
print "   <TD BGCOLOR=LightGreen ALIGN='Center' COLSPAN=2>UNIT NUMBER</TD>\n" ;
...
print "   <TD><INPUT TYPE=Text NAME=operation_time VALUE=\"$operation_time\" SIZE=18 MAXLENGTH=25 onChange='chkNum(this.form,this.value,\"24,8\")'></TD>\n" ;
...
print "   <TD><INPUT TYPE=Text NAME=aging_day VALUE=\"$aging_day\" SIZE=5 MAXLENGTH=3 onChange='chkNum(this.form,this.value,\"6,0\")'></TD>\n" ;
print " </TR>" ;
