...
print "   <TD COLSPAN=2>$item_type1</TD>\n" ;
print "   <TD COLSPAN=3>$item_type2</TD>\n" ;
print " </TR>" ;
 # FIのみ、客先梱包単位を入力できるようにする
 if ($CONF{'FI_PACKAGE_UNIT'} eq "1") {
     print " <TR>" ;
     print "   <TD BGCOLOR=LightGreen ALIGN='Right'>PACKAGE UNIT NUMBER</TD>\n" ;
     print "   <TD BGCOLOR=$BG_PUN COLSPAN=5>$package_unit_number $UNQ[$unit_package]</TD>\n" ;
     print " </TR>" ;
 }
print "</TBODY></TABLE>" ;
