<?php
	...
	$sql = "select top 150 a.PO_NO, cast(a.po_date as varchar(10)) as po_date, a.supplier_code, b.company, c.curr_short, c.curr_mark, a.amt_o, a.amt_l,
		a.req, prsn.person, cast(b.pdays as varchar(10))+'-'+b.pdesc as pterm, 
		replace(remark1,'CHAR(13)+CHAR(10)','<br/>') as remark1_2,
		replace(a.remark1,'CHAR(13)+CHAR(10)','\n') as remark1,
	...
	while($row = sqlsrv_fetch_object($data)){
		...
		$items[$rowno]->REMARK1_2 = str_replace('<BR/>', '<br/>', $rmk);
