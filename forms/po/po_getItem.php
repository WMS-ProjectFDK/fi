...
and u.curr_code='$curr' and u.supplier_code='$supp' and i.section_code='100' and $bypil and (u.ITEM_NO is null or u.ALTER_PROCEDURE = (select min(ALTER_PROCEDURE) from ITEMMAKER where ITEM_NO = u.ITEM_NO AND itemmaker.supplier_code=u.supplier_code))
