...
<<<<<<< HEAD
		dod.qty1 as delivery_qty, dod.uom_q, dod.u_price, dod.carved_stamp as date_code, dod.origin_code, replace(cast(mrk.marks as varchar(500)),'char(10)','<BR>') as remark_shipping
=======
