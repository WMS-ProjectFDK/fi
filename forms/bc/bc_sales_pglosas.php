...
<head>
<meta charset="UTF-8">
<title>BC UPLOAD SALES-PGLOSAS</title>
...
<?php include ('../../ico_logout.php'); ?>
	<table id="dg" title="BC UPLOAD SALES TO PGLOSAS" class="easyui-datagrid" style="width:100%;height:auto;" toolbar="#toolbar" fitcolumns="true" rownumbers="true"></table>
	<div id="toolbar">
		<div class="fitem" style="padding: 3px 3px;display:inline-block;">
			<span style="display:inline-block;">INV. Date</span>
			...
			<a href="bc_sales_pglosas_excel.php" id="dowloadBtn" style="width:200px;display:inline-block;" class="easyui-linkbutton c2" disabled="true"><i class="fa fa-download" aria-hidden="true"></i> 
	...
	<div id="dlg_upload" class="easyui-dialog" style="width:350px;height:auto;padding:5px 5px" closed="true" data-options="modal:true, position: 'center'">
		<form id="upd" method="post" enctype="multipart/form-data">
			<input class="easyui-filebox" name="fileexcel" id="fileexcel" style="width:250px;padding: 5px 5px;">
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#dg').datagrid({
			    columns:[[
				    {field:'PEB_NO', halign:'center', align:'center', title:'PEB NO.',width:70},
				    {field:'PE_NO', halign:'center', align:'center', title:'PE NO.',width:70},
				    {field:'INV_DATE', halign:'center', title:'INV. DATE',width:70, align:'center'},
				    {field:'CUSTOMER', halign:'center', title:'CUSTOMER',width:200},
				    {field:'DO_NO', halign:'center', title:'INV NO.',width:70},
		...
		function uploaddataNya(){
			...
			$('#upd').form('submit',{
				url: 'bc_sales_pglosas_process_upload.php',
				onSubmit: function(){
