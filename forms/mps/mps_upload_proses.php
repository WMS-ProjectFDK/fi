...
for($i=5;$i<=$hasildata;$i++){
    ...
    $field1 .= "CR_DATE,";                   $value1 .= "convert(date,'$k'),";        //DD/MM/YY
    $field1 .= "REQUESTED_ETD,";             $value1 .= "convert(date,'$l'),";        //DD/MM/YY
    ...
    $field1 .= "UPLOAD_DATE,";               $value1 .= "SYSDATETIME(),";                  //SYSDATE  'YYYY/MM/DD HH24:MI:SS'
...
echo json_encode("Success = ".$ins1);//.", Failed = ".$failed);
?>