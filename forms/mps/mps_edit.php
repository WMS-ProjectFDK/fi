...
<div id="toolbar" style="padding:3px 3px;">
	<fieldset style="margin-left;border-radius:4px;height:70px;width:98%"><legend><span class="style3"><strong> MPS FILTER </strong></span></legend>
...
<script type="text/javascript">
    ...
    function filterData(){
		...
		console.log('mps_edit_get.php'+pdf_url);
    }
