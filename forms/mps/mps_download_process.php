...
if (isset($_SESSION['id_wms'])){
    ...
    $sql = "select SYS_DATE,FLG, CONVERT(varchar(10),UPLOAD_DATE,103) as UPLOAD_DATE,ITEM_NO,ITEM_NAME,
        BATERY_TYPE,CELL_GRADE,PO_NO,PO_LINE_NO,WORK_ORDER,CONSIGNEE,PACKAGE_TYPE,DATE_CODE,CR_DATE,
        REQUESTED_ETD,STATUS,LABEL_ITEM_NUMBER,LABEL_NAME,QTY,MAN_POWER,OPERATION_TIME,LABEL_TYPE,CAPACITY,REMARK
        from zvw_mps";
    ...
    while($dt = sqlsrv_fetch_object($data)){
        ...
        $sqlD = "select PO_NO, PO_LINE_NO, convert(nvarchar(10),MPS_DATE, 103) as MPS_DATE_FORMAT, MPS_QTY
            from MPS_DETAILS 
