...
$cek = "select no_id, cc.description + '(' + cast(bb.this_inventory as nvarchar(20)) + ')' description, $value item_no, item_desc from ztb_mrp_data_pck aa inner join whinventory bb on aa.item_no = bb.item_no inner join item cc on aa.item_no = cc.item_no  $where" ;
