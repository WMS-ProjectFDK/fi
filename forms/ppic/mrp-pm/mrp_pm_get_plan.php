<?php
 ...
 from
		...
		left outer join
		(select distinct max(line_no) line_no, item_no,max(purchase_leadtime) purchase_leadtime from itemmaker group by item_no)bb on aa.item_no=bb.item_no
