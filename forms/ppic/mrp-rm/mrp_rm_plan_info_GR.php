<?php
	...
	$cek = "select a.gr_no, cast(a.gr_date as varchar(10)) as gr_date, b.item_no, i.item, i.description, b.qty, b.uom_q, u.unit, 
		...
		where a.gr_date ='$tgl_plan' AND b.item_no= $item_no
		";
