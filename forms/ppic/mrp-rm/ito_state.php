...
<div id="toolbar" style="padding:3px 3px;">	
  ...
  <fieldset style="height: 83px;margin-left: 1090px;margin-top: 7px;border-radius:4px;">
  	<div class="fitem" align="center" style="height: 40px;">	
		...
		<span style="width:180px;display:inline-block;"><input type="checkbox" name="ck_ai" id="ck_ai" >Incld Support Material</input></span>
	</div>
	
	<div class="fitem" align="center" style="height: 30px; ">	
		<a href="javascript:void(0)" id="dwld" style="width: 140px;" class="easyui-linkbutton c2" onclick="download_ito()" disabled="true"><i class="fa fa-download" aria-hidden="true"></i> DOWNLOAD ALL</a>
	</div>
  </fieldset>
</div>
...
<script type="text/javascript">
	...
	function filterData(){
		...
		pdf_url_ito = '?cmb_item_no='+$('#cmb_item_no').combobox('getValue')+
					  '&ck_item_no='+ck_item_no+
					  '&cmb_day='+$('#cmb_day').combobox('getValue')+
					  '&ckday='+ck_day+
					  '&sts_ito='+sts+
		...
		$('#dg').datagrid({
	    	...
	    	columns:[[
				...
				{field:'ITEM_DESC',title:'<b>ITEM TYPE</b>',width:300, halign: 'center'},
				...
				{field:'N_1',title: '<b>'+AddDateII(1)+'</b>', width:100, halign: 'center', align: 'right'},
				{field:'N_2',title: '<b>'+AddDateII(2)+'</b>', width:100, halign: 'center', align: 'right'},
				{field:'N_3',title: '<b>'+AddDateII(3)+'</b>', width:100, halign: 'center', align: 'right'},
				{field:'N_4',title: '<b>'+AddDateII(4)+'</b>', width:100, halign: 'center', align: 'right'},
				{field:'N_5',title: '<b>'+AddDateII(5)+'</b>', width:100, halign: 'center', align: 'right'},
				{field:'N_6',title: '<b>'+AddDateII(6)+'</b>', width:100, halign: 'center', align: 'right'},
				{field:'N_7',title: '<b>'+AddDateII(7)+'</b>', width:100, halign: 'center', align: 'right'},
				{field:'N_8',title: '<b>'+AddDateII(8)+'</b>', width:100, halign: 'center', align: 'right'},
				{field:'N_9',title: '<b>'+AddDateII(9)+'</b>', width:100, halign: 'center', align: 'right'},
			...
			onExpandRow: function(index,row){
				...
				listbrg.datagrid({
                	title: 'Detail Type ('+row.ITEM_DESC.trim()+')',
                	url:'ito_state_get_detail.php?ty='+row.ITEM_DESC.trim()+'&cmb_day='+$('#cmb_day').combobox('getValue')+'&ck_day='+ck_day+'&sts_ito='+sts,
					toolbar: '#ddv'+index,
					singleSelect:true,
					loadMsg:'load data ...',
					frozenColumns:[[
					...
					onDblClickRow:function(row){
						var row = listbrg.datagrid('getSelected');
						var ty = row.ITEM_TYPE;
						var item = row.ITEM_NO;
						var item_desc = row.ITEM_DESC;
						//alert(ty);
						pdf_url2 = '?cmb_type='+ty+'&cmb_item_no='+item+'&item_name='+item_desc+'&from=ITO';
						var url2 = 'mrp_rm_plan.php'+encodeURIComponent(pdf_url2);
				...
				if (ck_day != 'true'){
					if(view_p == 5){
						listbrg.datagrid('showColumn','N_1');			listbrg.datagrid('hideColumn','N_31');			listbrg.datagrid('hideColumn','N_61');
						listbrg.datagrid('showColumn','N_2');			listbrg.datagrid('hideColumn','N_32');			listbrg.datagrid('hideColumn','N_62');
						listbrg.datagrid('showColumn','N_3');			listbrg.datagrid('hideColumn','N_33');			listbrg.datagrid('hideColumn','N_63');
						listbrg.datagrid('showColumn','N_4');			listbrg.datagrid('hideColumn','N_34');			listbrg.datagrid('hideColumn','N_64');
						listbrg.datagrid('showColumn','N_5');			listbrg.datagrid('hideColumn','N_35');			listbrg.datagrid('hideColumn','N_65');
						listbrg.datagrid('hideColumn','N_6');			listbrg.datagrid('hideColumn','N_36');			listbrg.datagrid('hideColumn','N_66');
						listbrg.datagrid('hideColumn','N_7');			listbrg.datagrid('hideColumn','N_37');			listbrg.datagrid('hideColumn','N_67');
						listbrg.datagrid('hideColumn','N_8');			listbrg.datagrid('hideColumn','N_38');			listbrg.datagrid('hideColumn','N_68');
						listbrg.datagrid('hideColumn','N_9');			listbrg.datagrid('hideColumn','N_39');			listbrg.datagrid('hideColumn','N_69');
						listbrg.datagrid('hideColumn','N_10');			listbrg.datagrid('hideColumn','N_40');			listbrg.datagrid('hideColumn','N_70');
						listbrg.datagrid('hideColumn','N_11');			listbrg.datagrid('hideColumn','N_41');			listbrg.datagrid('hideColumn','N_71');
						listbrg.datagrid('hideColumn','N_12');			listbrg.datagrid('hideColumn','N_42');			listbrg.datagrid('hideColumn','N_72');
						listbrg.datagrid('hideColumn','N_13');			listbrg.datagrid('hideColumn','N_43');			listbrg.datagrid('hideColumn','N_73');
						listbrg.datagrid('hideColumn','N_14');			listbrg.datagrid('hideColumn','N_44');			listbrg.datagrid('hideColumn','N_74');
						listbrg.datagrid('hideColumn','N_15');			listbrg.datagrid('hideColumn','N_45');			listbrg.datagrid('hideColumn','N_75');
						listbrg.datagrid('hideColumn','N_16');			listbrg.datagrid('hideColumn','N_46');			listbrg.datagrid('hideColumn','N_76');
						listbrg.datagrid('hideColumn','N_17');			listbrg.datagrid('hideColumn','N_47');			listbrg.datagrid('hideColumn','N_77');
						listbrg.datagrid('hideColumn','N_18');			listbrg.datagrid('hideColumn','N_48');			listbrg.datagrid('hideColumn','N_78');
						listbrg.datagrid('hideColumn','N_19');			listbrg.datagrid('hideColumn','N_49');			listbrg.datagrid('hideColumn','N_79');
						listbrg.datagrid('hideColumn','N_20');			listbrg.datagrid('hideColumn','N_50');			listbrg.datagrid('hideColumn','N_80');
						listbrg.datagrid('hideColumn','N_21');			listbrg.datagrid('hideColumn','N_51');			listbrg.datagrid('hideColumn','N_81');
						listbrg.datagrid('hideColumn','N_22');			listbrg.datagrid('hideColumn','N_52');			listbrg.datagrid('hideColumn','N_82');
						listbrg.datagrid('hideColumn','N_23');			listbrg.datagrid('hideColumn','N_53');			listbrg.datagrid('hideColumn','N_83');
						listbrg.datagrid('hideColumn','N_24');			listbrg.datagrid('hideColumn','N_54');			listbrg.datagrid('hideColumn','N_84');
						listbrg.datagrid('hideColumn','N_25');			listbrg.datagrid('hideColumn','N_55');			listbrg.datagrid('hideColumn','N_85');
						listbrg.datagrid('hideColumn','N_26');			listbrg.datagrid('hideColumn','N_56');			listbrg.datagrid('hideColumn','N_86');
						listbrg.datagrid('hideColumn','N_27');			listbrg.datagrid('hideColumn','N_57');			listbrg.datagrid('hideColumn','N_87');
						listbrg.datagrid('hideColumn','N_28');			listbrg.datagrid('hideColumn','N_58');			listbrg.datagrid('hideColumn','N_88');
						listbrg.datagrid('hideColumn','N_29');			listbrg.datagrid('hideColumn','N_59');			listbrg.datagrid('hideColumn','N_89');
						listbrg.datagrid('hideColumn','N_30');			listbrg.datagrid('hideColumn','N_60');			listbrg.datagrid('hideColumn','N_90');
					}else if (view_p == 10){
						listbrg.datagrid('showColumn','N_1');			listbrg.datagrid('hideColumn','N_31');			listbrg.datagrid('hideColumn','N_61');
						listbrg.datagrid('showColumn','N_2');			listbrg.datagrid('hideColumn','N_32');			listbrg.datagrid('hideColumn','N_62');
						listbrg.datagrid('showColumn','N_3');			listbrg.datagrid('hideColumn','N_33');			listbrg.datagrid('hideColumn','N_63');
						listbrg.datagrid('showColumn','N_4');			listbrg.datagrid('hideColumn','N_34');			listbrg.datagrid('hideColumn','N_64');
						listbrg.datagrid('showColumn','N_5');			listbrg.datagrid('hideColumn','N_35');			listbrg.datagrid('hideColumn','N_65');
						listbrg.datagrid('showColumn','N_6');			listbrg.datagrid('hideColumn','N_36');			listbrg.datagrid('hideColumn','N_66');
						listbrg.datagrid('showColumn','N_7');			listbrg.datagrid('hideColumn','N_37');			listbrg.datagrid('hideColumn','N_67');
						listbrg.datagrid('showColumn','N_8');			listbrg.datagrid('hideColumn','N_38');			listbrg.datagrid('hideColumn','N_68');
						listbrg.datagrid('showColumn','N_9');			listbrg.datagrid('hideColumn','N_39');			listbrg.datagrid('hideColumn','N_69');
						listbrg.datagrid('showColumn','N_10');			listbrg.datagrid('hideColumn','N_40');			listbrg.datagrid('hideColumn','N_70');
						listbrg.datagrid('hideColumn','N_11');			listbrg.datagrid('hideColumn','N_41');			listbrg.datagrid('hideColumn','N_71');
						listbrg.datagrid('hideColumn','N_12');			listbrg.datagrid('hideColumn','N_42');			listbrg.datagrid('hideColumn','N_72');
						listbrg.datagrid('hideColumn','N_13');			listbrg.datagrid('hideColumn','N_43');			listbrg.datagrid('hideColumn','N_73');
						listbrg.datagrid('hideColumn','N_14');			listbrg.datagrid('hideColumn','N_44');			listbrg.datagrid('hideColumn','N_74');
						...
						listbrg.datagrid('showColumn','N_9');			listbrg.datagrid('hideColumn','N_39');			listbrg.datagrid('hideColumn','N_69');
						listbrg.datagrid('showColumn','N_10');			listbrg.datagrid('hideColumn','N_40');			listbrg.datagrid('hideColumn','N_70');
						listbrg.datagrid('showColumn','N_11');			listbrg.datagrid('hideColumn','N_41');			listbrg.datagrid('hideColumn','N_71');
						listbrg.datagrid('showColumn','N_12');			listbrg.datagrid('hideColumn','N_42');			listbrg.datagrid('hideColumn','N_72');
						listbrg.datagrid('showColumn','N_13');			listbrg.datagrid('hideColumn','N_43');			listbrg.datagrid('hideColumn','N_73');
						listbrg.datagrid('showColumn','N_14');			listbrg.datagrid('hideColumn','N_44');			listbrg.datagrid('hideColumn','N_74');
						listbrg.datagrid('showColumn','N_15');			listbrg.datagrid('hideColumn','N_45');			listbrg.datagrid('hideColumn','N_75');
						listbrg.datagrid('showColumn','N_16');			listbrg.datagrid('hideColumn','N_46');			listbrg.datagrid('hideColumn','N_76');
						listbrg.datagrid('showColumn','N_17');			listbrg.datagrid('hideColumn','N_47');			listbrg.datagrid('hideColumn','N_77');
						listbrg.datagrid('showColumn','N_18');			listbrg.datagrid('hideColumn','N_48');			listbrg.datagrid('hideColumn','N_78');
						listbrg.datagrid('showColumn','N_19');			listbrg.datagrid('hideColumn','N_49');			listbrg.datagrid('hideColumn','N_79');
						listbrg.datagrid('showColumn','N_20');			listbrg.datagrid('hideColumn','N_50');			listbrg.datagrid('hideColumn','N_80');
						listbrg.datagrid('hideColumn','N_21');			listbrg.datagrid('hideColumn','N_51');			listbrg.datagrid('hideColumn','N_81');
						listbrg.datagrid('hideColumn','N_22');			listbrg.datagrid('hideColumn','N_52');			listbrg.datagrid('hideColumn','N_82');
						listbrg.datagrid('hideColumn','N_23');			listbrg.datagrid('hideColumn','N_53');			listbrg.datagrid('hideColumn','N_83');
						listbrg.datagrid('hideColumn','N_24');			listbrg.datagrid('hideColumn','N_54');			listbrg.datagrid('hideColumn','N_84');
						...
						listbrg.datagrid('showColumn','N_19');			listbrg.datagrid('hideColumn','N_49');			listbrg.datagrid('hideColumn','N_79');
						listbrg.datagrid('showColumn','N_20');			listbrg.datagrid('hideColumn','N_50');			listbrg.datagrid('hideColumn','N_80');
						listbrg.datagrid('showColumn','N_21');			listbrg.datagrid('hideColumn','N_51');			listbrg.datagrid('hideColumn','N_81');
						listbrg.datagrid('showColumn','N_22');			listbrg.datagrid('hideColumn','N_52');			listbrg.datagrid('hideColumn','N_82');
						listbrg.datagrid('showColumn','N_23');			listbrg.datagrid('hideColumn','N_53');			listbrg.datagrid('hideColumn','N_83');
						listbrg.datagrid('showColumn','N_24');			listbrg.datagrid('hideColumn','N_54');			listbrg.datagrid('hideColumn','N_84');
						listbrg.datagrid('showColumn','N_25');			listbrg.datagrid('hideColumn','N_55');			listbrg.datagrid('hideColumn','N_85');
						listbrg.datagrid('showColumn','N_26');			listbrg.datagrid('hideColumn','N_56');			listbrg.datagrid('hideColumn','N_86');
						listbrg.datagrid('showColumn','N_27');			listbrg.datagrid('hideColumn','N_57');			listbrg.datagrid('hideColumn','N_87');
						listbrg.datagrid('showColumn','N_28');			listbrg.datagrid('hideColumn','N_58');			listbrg.datagrid('hideColumn','N_88');
						listbrg.datagrid('showColumn','N_29');			listbrg.datagrid('hideColumn','N_59');			listbrg.datagrid('hideColumn','N_89');
						listbrg.datagrid('showColumn','N_30');			listbrg.datagrid('hideColumn','N_60');			listbrg.datagrid('hideColumn','N_90');
					}else if (view_p == 40){
						listbrg.datagrid('showColumn','N_1');			listbrg.datagrid('showColumn','N_31');			listbrg.datagrid('hideColumn','N_61');
						listbrg.datagrid('showColumn','N_2');			listbrg.datagrid('showColumn','N_32');			listbrg.datagrid('hideColumn','N_62');
						listbrg.datagrid('showColumn','N_3');			listbrg.datagrid('showColumn','N_33');			listbrg.datagrid('hideColumn','N_63');
						listbrg.datagrid('showColumn','N_4');			listbrg.datagrid('showColumn','N_34');			listbrg.datagrid('hideColumn','N_64');
						listbrg.datagrid('showColumn','N_5');			listbrg.datagrid('showColumn','N_35');			listbrg.datagrid('hideColumn','N_65');
						listbrg.datagrid('hideColumn','N_6');			listbrg.datagrid('showColumn','N_36');			listbrg.datagrid('hideColumn','N_66');
						listbrg.datagrid('showColumn','N_7');			listbrg.datagrid('showColumn','N_37');			listbrg.datagrid('hideColumn','N_67');
						listbrg.datagrid('showColumn','N_8');			listbrg.datagrid('showColumn','N_38');			listbrg.datagrid('hideColumn','N_68');
						listbrg.datagrid('showColumn','N_9');			listbrg.datagrid('showColumn','N_39');			listbrg.datagrid('hideColumn','N_69');
						listbrg.datagrid('showColumn','N_10');			listbrg.datagrid('showColumn','N_40');			listbrg.datagrid('hideColumn','N_70');
						listbrg.datagrid('showColumn','N_11');			listbrg.datagrid('hideColumn','N_41');			listbrg.datagrid('hideColumn','N_71');
						listbrg.datagrid('showColumn','N_12');			listbrg.datagrid('hideColumn','N_42');			listbrg.datagrid('hideColumn','N_72');
						listbrg.datagrid('showColumn','N_13');			listbrg.datagrid('hideColumn','N_43');			listbrg.datagrid('hideColumn','N_73');
						listbrg.datagrid('showColumn','N_14');			listbrg.datagrid('hideColumn','N_44');			listbrg.datagrid('hideColumn','N_74');
						...
						listbrg.datagrid('showColumn','N_4');			listbrg.datagrid('showColumn','N_34');			listbrg.datagrid('hideColumn','N_64');
						listbrg.datagrid('showColumn','N_5');			listbrg.datagrid('showColumn','N_35');			listbrg.datagrid('hideColumn','N_65');
						listbrg.datagrid('showColumn','N_6');			listbrg.datagrid('showColumn','N_36');			listbrg.datagrid('hideColumn','N_66');
						listbrg.datagrid('showColumn','N_7');			listbrg.datagrid('showColumn','N_37');			listbrg.datagrid('hideColumn','N_67');
						listbrg.datagrid('showColumn','N_8');			listbrg.datagrid('showColumn','N_38');			listbrg.datagrid('hideColumn','N_68');
						listbrg.datagrid('showColumn','N_9');			listbrg.datagrid('showColumn','N_39');			listbrg.datagrid('hideColumn','N_69');
						listbrg.datagrid('showColumn','N_10');			listbrg.datagrid('showColumn','N_40');			listbrg.datagrid('hideColumn','N_70');
						listbrg.datagrid('showColumn','N_11');			listbrg.datagrid('showColumn','N_41');			listbrg.datagrid('hideColumn','N_71');
						listbrg.datagrid('showColumn','N_12');			listbrg.datagrid('showColumn','N_42');			listbrg.datagrid('hideColumn','N_72');
						listbrg.datagrid('showColumn','N_13');			listbrg.datagrid('showColumn','N_43');			listbrg.datagrid('hideColumn','N_73');
						listbrg.datagrid('showColumn','N_14');			listbrg.datagrid('showColumn','N_44');			listbrg.datagrid('hideColumn','N_74');
						listbrg.datagrid('showColumn','N_15');			listbrg.datagrid('showColumn','N_45');			listbrg.datagrid('hideColumn','N_75');
						listbrg.datagrid('showColumn','N_16');			listbrg.datagrid('showColumn','N_46');			listbrg.datagrid('hideColumn','N_76');
						listbrg.datagrid('showColumn','N_17');			listbrg.datagrid('showColumn','N_47');			listbrg.datagrid('hideColumn','N_77');
						listbrg.datagrid('showColumn','N_18');			listbrg.datagrid('showColumn','N_48');			listbrg.datagrid('hideColumn','N_78');
						listbrg.datagrid('showColumn','N_19');			listbrg.datagrid('showColumn','N_49');			listbrg.datagrid('hideColumn','N_79');
						listbrg.datagrid('showColumn','N_20');			listbrg.datagrid('showColumn','N_50');			listbrg.datagrid('hideColumn','N_80');
						listbrg.datagrid('showColumn','N_21');			listbrg.datagrid('hideColumn','N_51');			listbrg.datagrid('hideColumn','N_81');
						listbrg.datagrid('showColumn','N_22');			listbrg.datagrid('hideColumn','N_52');			listbrg.datagrid('hideColumn','N_82');
						listbrg.datagrid('showColumn','N_23');			listbrg.datagrid('hideColumn','N_53');			listbrg.datagrid('hideColumn','N_83');
						listbrg.datagrid('showColumn','N_24');			listbrg.datagrid('hideColumn','N_54');			listbrg.datagrid('hideColumn','N_84');
						...
						listbrg.datagrid('showColumn','N_19');			listbrg.datagrid('showColumn','N_49');			listbrg.datagrid('hideColumn','N_79');
						listbrg.datagrid('showColumn','N_20');			listbrg.datagrid('showColumn','N_50');			listbrg.datagrid('hideColumn','N_80');
						listbrg.datagrid('showColumn','N_21');			listbrg.datagrid('showColumn','N_51');			listbrg.datagrid('hideColumn','N_81');
						listbrg.datagrid('showColumn','N_22');			listbrg.datagrid('showColumn','N_52');			listbrg.datagrid('hideColumn','N_82');
						listbrg.datagrid('showColumn','N_23');			listbrg.datagrid('showColumn','N_53');			listbrg.datagrid('hideColumn','N_83');
						listbrg.datagrid('showColumn','N_24');			listbrg.datagrid('showColumn','N_54');			listbrg.datagrid('hideColumn','N_84');
						listbrg.datagrid('showColumn','N_25');			listbrg.datagrid('showColumn','N_55');			listbrg.datagrid('hideColumn','N_85');
						listbrg.datagrid('showColumn','N_26');			listbrg.datagrid('showColumn','N_56');			listbrg.datagrid('hideColumn','N_86');
						listbrg.datagrid('showColumn','N_27');			listbrg.datagrid('showColumn','N_57');			listbrg.datagrid('hideColumn','N_87');
						listbrg.datagrid('showColumn','N_28');			listbrg.datagrid('showColumn','N_58');			listbrg.datagrid('hideColumn','N_88');
						listbrg.datagrid('showColumn','N_29');			listbrg.datagrid('showColumn','N_59');			listbrg.datagrid('hideColumn','N_89');
						listbrg.datagrid('showColumn','N_30');			listbrg.datagrid('showColumn','N_60');			listbrg.datagrid('hideColumn','N_90');
					}else if (view_p == 70){
						listbrg.datagrid('showColumn','N_1');			listbrg.datagrid('showColumn','N_31');			listbrg.datagrid('showColumn','N_61');
						listbrg.datagrid('showColumn','N_2');			listbrg.datagrid('showColumn','N_32');			listbrg.datagrid('showColumn','N_62');
						listbrg.datagrid('showColumn','N_3');			listbrg.datagrid('showColumn','N_33');			listbrg.datagrid('showColumn','N_63');
						listbrg.datagrid('showColumn','N_4');			listbrg.datagrid('showColumn','N_34');			listbrg.datagrid('showColumn','N_64');
						listbrg.datagrid('showColumn','N_5');			listbrg.datagrid('showColumn','N_35');			listbrg.datagrid('showColumn','N_65');
						listbrg.datagrid('showColumn','N_6');			listbrg.datagrid('showColumn','N_36');			listbrg.datagrid('showColumn','N_66');
						listbrg.datagrid('showColumn','N_7');			listbrg.datagrid('showColumn','N_37');			listbrg.datagrid('showColumn','N_67');
						listbrg.datagrid('showColumn','N_8');			listbrg.datagrid('showColumn','N_38');			listbrg.datagrid('showColumn','N_68');
						listbrg.datagrid('showColumn','N_9');			listbrg.datagrid('showColumn','N_39');			listbrg.datagrid('showColumn','N_69');
						listbrg.datagrid('showColumn','N_10');			listbrg.datagrid('showColumn','N_40');			listbrg.datagrid('showColumn','N_70');
						listbrg.datagrid('showColumn','N_11');			listbrg.datagrid('showColumn','N_41');			listbrg.datagrid('hideColumn','N_71');
						listbrg.datagrid('showColumn','N_12');			listbrg.datagrid('showColumn','N_42');			listbrg.datagrid('hideColumn','N_72');
						listbrg.datagrid('showColumn','N_13');			listbrg.datagrid('showColumn','N_43');			listbrg.datagrid('hideColumn','N_73');
						listbrg.datagrid('showColumn','N_14');			listbrg.datagrid('showColumn','N_44');			listbrg.datagrid('hideColumn','N_74');
						...
						listbrg.datagrid('showColumn','N_9');			listbrg.datagrid('showColumn','N_39');			listbrg.datagrid('showColumn','N_69');
						listbrg.datagrid('showColumn','N_10');			listbrg.datagrid('showColumn','N_40');			listbrg.datagrid('showColumn','N_70');
						listbrg.datagrid('showColumn','N_11');			listbrg.datagrid('showColumn','N_41');			listbrg.datagrid('showColumn','N_71');
						listbrg.datagrid('showColumn','N_12');			listbrg.datagrid('showColumn','N_42');			listbrg.datagrid('showColumn','N_72');
						listbrg.datagrid('showColumn','N_13');			listbrg.datagrid('showColumn','N_43');			listbrg.datagrid('showColumn','N_73');
						listbrg.datagrid('showColumn','N_14');			listbrg.datagrid('showColumn','N_44');			listbrg.datagrid('showColumn','N_74');
						listbrg.datagrid('showColumn','N_15');			listbrg.datagrid('showColumn','N_45');			listbrg.datagrid('showColumn','N_75');
						listbrg.datagrid('showColumn','N_16');			listbrg.datagrid('showColumn','N_46');			listbrg.datagrid('showColumn','N_76');
						listbrg.datagrid('showColumn','N_17');			listbrg.datagrid('showColumn','N_47');			listbrg.datagrid('showColumn','N_77');
						listbrg.datagrid('showColumn','N_18');			listbrg.datagrid('showColumn','N_48');			listbrg.datagrid('showColumn','N_78');
						listbrg.datagrid('showColumn','N_19');			listbrg.datagrid('showColumn','N_49');			listbrg.datagrid('showColumn','N_79');
						listbrg.datagrid('showColumn','N_20');			listbrg.datagrid('showColumn','N_50');			listbrg.datagrid('showColumn','N_80');
						listbrg.datagrid('showColumn','N_21');			listbrg.datagrid('showColumn','N_51');			listbrg.datagrid('hideColumn','N_81');
						listbrg.datagrid('showColumn','N_22');			listbrg.datagrid('showColumn','N_52');			listbrg.datagrid('hideColumn','N_82');
						listbrg.datagrid('showColumn','N_23');			listbrg.datagrid('showColumn','N_53');			listbrg.datagrid('hideColumn','N_83');
						listbrg.datagrid('showColumn','N_24');			listbrg.datagrid('showColumn','N_54');			listbrg.datagrid('hideColumn','N_84');
					...
					listbrg.datagrid('showColumn','N_19');			listbrg.datagrid('showColumn','N_49');			listbrg.datagrid('showColumn','N_79');
					listbrg.datagrid('showColumn','N_20');			listbrg.datagrid('showColumn','N_50');			listbrg.datagrid('showColumn','N_80');
					listbrg.datagrid('showColumn','N_21');			listbrg.datagrid('showColumn','N_51');			listbrg.datagrid('showColumn','N_81');
					listbrg.datagrid('showColumn','N_22');			listbrg.datagrid('showColumn','N_52');			listbrg.datagrid('showColumn','N_82');
					listbrg.datagrid('showColumn','N_23');			listbrg.datagrid('showColumn','N_53');			listbrg.datagrid('showColumn','N_83');
					listbrg.datagrid('showColumn','N_24');			listbrg.datagrid('showColumn','N_54');			listbrg.datagrid('showColumn','N_84');
					listbrg.datagrid('showColumn','N_25');			listbrg.datagrid('showColumn','N_55');			listbrg.datagrid('showColumn','N_85');
					listbrg.datagrid('showColumn','N_26');			listbrg.datagrid('showColumn','N_56');			listbrg.datagrid('showColumn','N_86');
					listbrg.datagrid('showColumn','N_27');			listbrg.datagrid('showColumn','N_57');			listbrg.datagrid('showColumn','N_87');
					listbrg.datagrid('showColumn','N_28');			listbrg.datagrid('showColumn','N_58');			listbrg.datagrid('showColumn','N_88');
					listbrg.datagrid('showColumn','N_29');			listbrg.datagrid('showColumn','N_59');			listbrg.datagrid('showColumn','N_89');
					listbrg.datagrid('showColumn','N_30');			listbrg.datagrid('showColumn','N_60');			listbrg.datagrid('showColumn','N_90');
				}
			},
			onLoadSuccess: function(data){
				for (var i=0; i<data.rows.length; i++){
					var jum_item = parseInt($(this).datagrid('getData').rows[i].JUM_ITEM);
				 	if (jum_item == 1){						
	...
	function download_ito(){
		if(pdf_url_ito == ''){
			...
			window.open('ito_state_xls.php'+pdf_url_ito, '_blank');
		}
	}
