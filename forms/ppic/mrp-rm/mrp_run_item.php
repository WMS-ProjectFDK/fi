...
$q= "select top 3 tahun+bulan as period,bulan, tahun, tot, cast(upload_time as varchar(10) as upload_time,
...
$sq = "
	select substring(assy_line, 0, 4)+cell_type as Grade,sum(qty) TotalProduksi, cast(upload_time as varchar(10) as upload_time,bulan,tahun,tot ,case when tot=0 then 'N' else 'Y' end as ket
