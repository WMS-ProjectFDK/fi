<?php
	...
	if($rdo_sts != 0){
		...
		$sql = "select item_no, item, description, last_inventory, standard_price, supplier_code, company, 
			gr_no, qty, last_date_buy, transaction_type, transaction_qty, transaction_date, cut_off 
			from zvw_slow_move 
			$where";
