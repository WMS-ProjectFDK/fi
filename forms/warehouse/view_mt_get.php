<?php
	...
	$where ="where $slip $wo $item d.slip_date between '$date_awal' and '$date_akhir'";
	
	include("../../connect/conn.php");

	$sql = "select distinct a.id,b.item_no as upper_item,b.brand,b.wo_no,b.plt_no, a.slip_no,cast(d.slip_date as varchar(10)) slip_date,
