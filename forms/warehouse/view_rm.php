...
<head>
<meta charset="UTF-8">
<title>VIEW TRANSACTION KANBAN-RM</title>
...
<table id="dg" title="VIEW TRANSACTION KANBAN RAW MATERIAL" class="easyui-datagrid" toolbar="#toolbar	" style="width:100%;height:490px;" rownumbers="true" fitColumns="true" singleSelect="true"></table>
	...
	function filterData(){
		...
		$('#dg').datagrid({
		    ...
		    columns:[[
			    ...
			    {field:'TANGGAL',title:'SLIP DATE',width:75, halign: 'center', align: 'center'},
			    {field:'LINE_NO',title:'INCOMING<br/>NO.',width:75, halign: 'center',align: 'center'},
			    {field:'ITEM_NO',title:'ITEM',width:65, halign: 'center', align: 'center'},
			    {field:'DESCRIPTION',title:'DESCRIPTION',width:200, halign: 'center'},
			    {field:'RACK',title:'RACK',width:150, halign: 'center'},
			    {field:'PALLET',title:'PALLET',width:50, halign: 'center', align: 'center'},
			    {field:'QTY',title:'QTY',width:70, halign: 'center', align: 'right'},
			    {field:'STS_KIRIM',title:'STATUS<br/>KIRIM', width:120, halign: 'center', align: 'center'},
			    {field:'STS_APPROVE',title:'STATUS<br/>APPROVE STOCK WH', width:120, halign: 'center', align: 'center'}
		    ]]
		})
		var dg = $('#dg').datagrid();
