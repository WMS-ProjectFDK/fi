...
$data = file_get_contents("bom_download_result_acc.json");
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('T'.$noRow, 'STANDARD_PRICE')
;
...
foreach ($someArray as $key => $value) {
    $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('T'.$noRow, $value['STANDARD_PRICE'])
    ;
...
header('Content-Disposition: attachment; filename="DOWNLOAD-MASTER-BOM-ACC.xlsx"');
