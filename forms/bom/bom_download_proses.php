...
if (isset($_SESSION['id_wms'])){
    $sql = "select st.UPPER_ITEM_NO, it1.ITEM as UPPER_ITEM, it1.DESCRIPTION as UPPER_DESCRIPTION, 
        ...
        st.LEVEL_NO, st.LINE_NO, st.REFERENCE_NUMBER, st.QUANTITY, u2.UNIT, st.QUANTITY_BASE, 
