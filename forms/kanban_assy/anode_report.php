...
<table id="dg" title="ANODE GEL REPORT" class="easyui-datagrid" toolbar="#toolbar" style="width:100%;height:450px;" data-options="rownumbers: true, singleSelect: true, iconCls: 'icon-save', method: 'get', showFooter: true">
    <thead frozen="true">
    <tr>
    	<th rowspan="2" data-options="field:'date_prod',halign: 'center', width:75">PRODUCT<br/>DATE</th>
    	<th rowspan="2" data-options="field:'type_gel',halign: 'center', align: 'center', width:60">TYPE<br/>GEL</th>
    ...
    <tr>
    	...
    	<th data-options="field:'qty_aqupec2',width:70, halign: 'center', align: 'right'" formatter="formatPrice">AQUPEC<br>HV-505 E</th>
    ...
    <tr>
    	...
    	<th data-options="field:'act_qty_aqupec2',width:70, halign: 'center', align: 'right'" formatter="formatPrice">AQUPEC<br>HV-505 E</th>
