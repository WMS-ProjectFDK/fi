	...
	*{
	...
	<script type="text/javascript">
		...
		function download_pack_plan(){
            ...
            $.post('packaging_plan_download_proses.php'+getUrl,{}).done(function(res){
				console.log(res);
				if (res == '"success"'){
            ...
            // window.open('packaging_plan_download_proses.php'+getUrl);
		}

        function download_excel(){
			url_download = 'packaging_plan_download_xls.php'+getUrl;
