...
print "<center>\n";
	...
	print "<form action='maker_view.cgi' method='post' name='inputform'>\n";
	print "<table border=0 cellspacing=1 cellpadding=1 width=680>\n";
		...
		if($ITEM_NO eq "" ){
			...
			print "<th width=100><BR></th>\n";
			print "<th width=100><BR></th>\n";
			print "<th width=100><input type='Button' NAME=BTN_TYPE1 value='BACK' onClick='history.back()'></th>\n";
			print "<th width=100><input type='Button' NAME=BTN_TYPE value='End' onClick='return GO_main()'></th>\n";
		}
...
#		print "</td>\n";
	...
	print "<tr>\n";
		...
		print "<td width=180 bgcolor='#ccccff' COLSPAN=3>$SUPPLIERS_PRICE<BR></td>\n";
	print "</tr>\n";
print "</table>\n";

print "<table border=0 cellspacing=1 cellpadding=1>\n";
#	print "<tr>\n";
#		print "<th width=90 bgcolor='#ccffcc'><h5>基準単価</th>\n";
...
#		print "<th width=90 bgcolor='#ccffcc'><h5>前期基準</th>\n";
...
#FLのみ、PO_STK_RATE(在庫変換率)を表示する  2003/12/2  By R.Tsutsui
$rows = ($CONF{'PO_STK_RATE'} ne "1"  ?  2 : 3) ;  
...
if ($CONF{'PO_STK_RATE'} eq "1") {
	print "<tr>\n";
		print "<th width=90  colspan=5 bgcolor='#ccffcc'><BR></th>\n";
...
#FLのみ、在庫変換率を表示
		if ($CONF{'PO_STK_RATE'} eq "1") {
			print "<tr align=center>\n";
				print "<td nowrap colspan=5   bgcolor='$wk_color'><BR></td>\n";
		...
		print "<tr align=center>\n";
			...
			print "<td nowrap align=right bgcolor='$wk_color'><BR></td>\n";
			print "<td nowrap align=right bgcolor='$wk_color'><BR></td>\n";
		#print "<th width=50 rowspan=2 bgcolor='$wk_color'><BR></th>\n";
		print "</tr>\n";
		print "<tr align=center>\n";
...
#FLのみ、在庫変換率を表示
		if ($CONF{'PO_STK_RATE'} eq "1") {
			print "<tr align=center>\n";
				print "<td nowrap align=right colspan=5 bgcolor='$wk_color'><BR></td>\n";
				print "<td nowrap align=right bgcolor='$wk_color'><BR></td>\n";
				print "<td nowrap align=right bgcolor='$wk_color'><BR></td>\n";
			print "</tr>\n";
		}
