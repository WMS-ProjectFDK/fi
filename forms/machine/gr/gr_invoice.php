...
<!DOCTYPE html>
   	...
   	<head>
   	<meta charset="UTF-8">
   	<title>Goods Receive Sparepart Invoice</title>
    ...
    <body>
		...
		<table id="dg" title="GOODS RECEIVE SPAREPARTS ADD INVOICE" class="easyui-datagrid" toolbar="#toolbar	" style="width:100%;height:490px;" rownumbers="true" fitColumns="true" singleSelect="true"></table>
			...
			$(function(){
				...
				$('#dg').datagrid( {
				    ...
				    columns:[[
		                ...
		                {field:'INV_DATE2',title:'INVOICE DATE',width:80,halign:'center',editor:{type:'datebox',options:{
							required:true,
