<?php
	...
	$rs = "select a.po_no, cast(b.po_date as varchar(12)) po_date, a.item_no, c.item, c.description_org as description, 
		c.stock_subject_code, c.class_code, c.standard_price, a.origin_code, d.country, a.line_no, a.qty, a.gr_qty, 
		(a.qty-a.gr_qty) as bal_qty, b.curr_code,e.curr_mark, e.curr_short,  a.uom_q, f.unit, b.ex_rate, cast(a.eta as varchar(12)) as eta,
		...
		left join sp_item c on a.item_no=c.item_no
		...
		left join sp_company g on b.supplier_code=g.company_code
		left join country h on g.country_code=h.country_code
		left join sp_whinventory whi on c.item_no=whi.item_no
