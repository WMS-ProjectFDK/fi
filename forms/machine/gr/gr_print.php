...
$sql = "select GR_NO, GR_DATE,INV_NO,cast(INV_DATE as varchar(11)) INV_DATE,SUPPLIER_CODE,EX_RATE,DO_NO,AMT_O,AMT_L,PERSON_CODE,PURCHASE_TYPE,SJ_NO,GR_TYPE,FEE_CURR_CODE,FEE_EX_RATE,TAX_INV_NO,BC_DOC,TAX_INV_DATE ,BC_NO,b.curr_short, c.company ,c.pdays,c.pdesc
    from sp_gr_header a 
	inner join sp_company c on a.supplier_code=c.company_code
    left outer join currency b on c.curr_code= b.curr_code
	where a.gr_no='$gr'";
...
$qry = "select b.po_no, b.item_no, c.item, c.description_org as description, b.qty, b.u_price, e.curr_short, 
...
$content .= "
	<thead>
		<tr>
			...
			<th valign='middle' align='center' style='font-size:10px;width:100px;height:25px;'>ITEM NO.</th>
...
while ($data=sqlsrv_fetch_object($result)){
	$content .= "
		<tr>
			...
			<td valign='middle' align='center' style='font-size:10px;width:100px;height:15px;'>".$data->ITEM_NO."</td>
			<td valign='middle' align='left' style='font-size:10px;width:250px;height:15px;'>".$data->DESCRIPTION."</td>
