...
if ($ck_date != "true"){
	$gr_date = "gh.gr_date BETWEEN CAST('$date_awal'as date) and CAST('$date_akhir' as date) and ";
...
$sql = "select gh.GR_NO,CAST(gh.GR_DATE as varchar(10)) GR_DATE,CAST(gh.INV_DATE as varchar(10)) INV_DATE,gh.SUPPLIER_CODE,gh.INV_NO,gh.CURR_CODE,gh.EX_RATE,gh.DO_NO,gh.BC_NO,gh.SHIP,c.COMPANY SUPPLIER,cc.CURR_MARK,gh.TAX_INV_NO,gh.BC_DOC
	FROM GR_HEADER gh
