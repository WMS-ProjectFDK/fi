<?php
	...
	$sql = "IF NOT EXISTS(select * from sp_itemmaker where item_no = '$item_no' and alter_procedure = $rank and supplier_code <> '$supplier_code') BEGIN 
	        update sp_itemmaker  set   operation_date = getdate(),
