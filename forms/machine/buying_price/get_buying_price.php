<?php
	...
	$sql = "select i.purchase_leadtime as lead,ALTER_PROCEDURE,i.SUPPLIER_CODE,cc.COMPANY, i.ITEM_NO, 
	it.[DESCRIPTION_ORG] as DESCRIPTION,i.ESTIMATE_PRICE ,cr.CURR_MARK
    from sp_ITEMMAKER i
    inner join sp_item it 
    on i.ITEM_NO  = it.ITEM_NO
    inner join sp_COMPANY cc 
