<?php
	...
	isnull(poh.po_no,'NEW') as po_no,isnull(cast(poh.po_date as varchar(11)),'-') as po_date,com.curr_code,poh.req requestor,isnull(poh.ex_rate,1) ex_rate,
	...
	from sp_company com  
	left join sp_po_header poh on poh.supplier_code=com.company_code
