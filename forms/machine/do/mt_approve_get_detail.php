<?php
	...
	$rowno=0;
	$rs = "select a.slip_no, b.line_no, b.item_no, c.description_org as description,
		b.qty,b.uom_q,d.unit,0 as sts, e.this_inventory as stock from sp_mte_header a
		inner join sp_mte_details b on a.slip_no=b.slip_no 
		left join sp_item c on b.item_no=c.item_no
		left join sp_unit d on b.uom_q=d.unit_code 
		left join sp_whinventory e on b.item_no = e.item_no
