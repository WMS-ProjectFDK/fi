...
<script type="text/javascript">
	...
	$(function(){
        ...
        if(sts == 'edit'){
            ...
            $('#SPECIFICATION').textbox('setValue', '<?=$SPECIFICATION?>');
...
<form id="add" method="post" action="<?=$post;?>" data-options="novalidate:true">
	...
	<fieldset style="border:1px solid #d0d0d0; border-radius:4px; width:97%; float:left;height: auto;padding:15px 15px;">
		...
		<div class="fitem">
			...
			<input style="width:900px;" name="DESCRIPTION" id="DESCRIPTION" class="easyui-textbox" required/>
		</div>
		<div class="fitem">
			<span style="width:150px;display:inline-block;">SPECIFICATION</span>
			<input style="width:900px;" name="SPECIFICATION" id="SPECIFICATION" class="easyui-textbox"/>
        </div>
	</fieldset>
	<fieldset style="border:1px solid #d0d0d0; border-radius:4px; width:97%; float:left;height: auto;padding:15px 15px;">
