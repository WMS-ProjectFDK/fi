...
<body>
	...
	<div id='dlg_add' class="easyui-dialog" style="width:1100px;height:550px;padding:5px 5px;" closed="true" buttons="#dlg-buttons-add" data-options="modal:true">
       ...
       <fieldset style="border-radius:4px; border-radius:4px; width:98%; height:190px; float:left;"><legend><span class="style3"><strong>Company Add</strong></span></legend>
            ...
            <span style="width:140px;display:inline-block;">Company Code.</span>
                <input  style="width:150px;" name="company_no_add" id="company_no_add" class="easyui-numberbox" required="true"/>
        ...
        <fieldset style="border-radius:4px; border-radius:4px; width:98%; height:150px; float:left;"><legend><span class="style3"><strong>Company Detail</strong></span></legend>
            ...
            <span style="width:140px;display:inline-block;">Supply Type</span>
                <select   style="width:300px;" name="cmb_supply_type_add" id="cmb_supply_type_add" class="easyui-combobox"  >
            ...
            <select style="width:300px;" name="cmb_bonded_add" id="cmb_bonded_add" class="easyui-combobox"  >
            ...
            <input style="width:150px;" name="days_trans_add" id="days_trans_add" class="easyui-numberbox" />
        ...
        <fieldset style="border-radius:4px; border-radius:4px; width:98%; height:150px; float:left;"><legend><span class="style3"><strong>Trade Terms</strong></span></legend>
           <div class="fitem">
            ...
            <div class="fitem">
                 ...
                 <input  style="width:150px;" name="pday_add" id="pday_add" class="easyui-numberbox" />
	...
	<!-- END ADD -->
	 ...
	 <fieldset style="border-radius:4px; border-radius:4px; width:98%; height:190px; float:left;"><legend><span class="style3"><strong>Company Add</strong></span></legend>
            <div class="fitem">
            <span style="width:140px;display:inline-block;">Company Code.</span>
                <input  style="width:150px;" name="company_no_edit" id="company_no_edit" class="easyui-numberbox" required="true"/>
                <span style="width:100px;display:inline-block;">Company Type</span>
        ...
        <fieldset style="border-radius:4px; border-radius:4px; width:98%; height:150px; float:left;"><legend><span class="style3"><strong>Company Detail</strong></span></legend>
            ...
            <span style="width:140px;display:inline-block;">Supply Type</span>
                <select   style="width:300px;" name="cmb_supply_type_edit" id="cmb_supply_type_edit" class="easyui-combobox"  >
            ...
            <div class="fitem">
            <span style="width:100px;display:inline-block;">Bonded Type</span>
            <select style="width:300px;" name="cmb_bonded_edit" id="cmb_bonded_edit" class="easyui-combobox"  >
                <option value="A" selected>OVERSEA BONDED </option>
                <option value="B" >LOCAL BONDED </option>
                <option value="C" >LOCAL NON BONDED</option>
            </select>
            <span style="width:140px;display:inline-block;">Days Of Transport</span>
            <input style="width:150px;" name="days_trans_edit" id="days_trans_edit" class="easyui-numberbox" />
            <span style="width:100px;display:inline-block;">Days</span>
        ...
        <fieldset style="border-radius:4px; border-radius:4px; width:98%; height:150px; float:left;"><legend><span class="style3"><strong>Trade Terms</strong></span></legend>
           <div class="fitem">
            ...
            <div class="fitem">
                 <span style="width:100px;display:inline-block;">Payment Days</span>
                 <input  style="width:150px;" name="pday_edit" id="pday_edit" class="easyui-numberbox" />
                <span style="width:100px;display:inline-block;">Payment Terms</span>
	...
	<div id="toolbar">
		...
		<div style="margin-top: 5px;margin: 5px;">
            <a href="javascript:void(0)" style="width: 140px;" class="easyui-linkbutton c2" id="filter" onclick="filterData()"><i class="fa fa-filter" aria-hidden="true"></i> Filter</a>
			...
			<a href="javascript:void(0)" style="width: 170px;" class="easyui-linkbutton c2" id="download" onclick="downloadCompany()"><i class="fa fa-download" aria-hidden="true"></i> Download Company</a>
		</div>
	</div>

	<table id="dg" title="MASTER COMPANY SPAREPARTS" toolbar="#toolbar" class="easyui-datagrid" rownumbers="true" fitColumns="true" style="width:100%;height:590px;"></table>
	...
	<div id="dlg-buttons-download">
		<a href="javascript:void(0)" class="easyui-linkbutton c6" onClick="downloadCompany_select()" style="width:100px"><i class="fa fa-download" aria-hidden="true"></i> DOWNLOAD</a>
	...
	<script type="text/javascript">
        ...
        $('#company_no_edit').numberbox({disabled: true});
        $('#company_no_add').numberbox({disabled: true});
        ...
        function saveAdd(){
            ...
            if(country == "" || companyName == "" || address == "" ||  companyType == "" || accpac == ""){
                ...
                $.post('post_company.php',{
                    ...
                    if(res.length == 38){
                        ...
                        $('#dg').datagrid('reload');
                        $.messager.alert('INFORMATION',res,'info');
                        $.messager.progress('close');
                    }else{
                        $.messager.alert('ERROR',res,'warning');
                        $.messager.progress('close');
		...
		function editCompany(){
			...
			if (row){
                ...
                $('#cmb_company_type_edit').combobox('setValue',row.COMPANY_TYPE_1);
		...
		function downloadCompany(){
            if(pdf_url=='') {
                ...
                $('#dg').datagrid('toExcel','List Company Report.xls')
            }
        }
		...
		// function downloadCompany_select(){
