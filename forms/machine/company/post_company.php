...
if (isset($_SESSION['id_wms'])){
    ...
    $cek = "select isnull(max(company_code),0)+1 companyCode from SP_COMPANY where COMPANY_CODE < 499999";
        ...
        if($data_save === false ) {
            if(($errors = sqlsrv_errors() ) != null) {  
                foreach( $errors as $error){  
                    $msg .= "message: ".$error[ 'message']."<br/>".$sql;  
                }  
            }
        }
...
if($msg != ''){
	...
	echo "Insert data company $companyCode, success !!";
}
